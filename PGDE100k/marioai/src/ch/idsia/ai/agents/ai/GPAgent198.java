...
//                        show(cur_char);
	...
	byte[][] landscape = observation.getLevelSceneObservation();// default: ZLevelScene = 1  
	 ...
	 if( observation.isMarioOnGround() ){ if( observation.mayMarioJump() ){ if( observation.isMarioOnGround() ){ if( landscape[11+ -2 ][11+ -2 ] != 0 ){ if( observation.isMarioOnGround() ){ if( enemies[11+ 0 ][11+ 1 ] != Sprite.KIND_SPIKY ){ action[ Mario.KEY_DOWN ] = true ;
 } } action[ Mario.KEY_DOWN ] = true ;
 }else{ if( landscape[11+ 1 ][11+ 1 ] != 0 ){ action[ Mario.KEY_JUMP ] = true ;
 } } }else{ if( enemies[11+ -2 ][11+ 2 ] != Sprite.KIND_RED_KOOPA ){ action[ Mario.KEY_DOWN ] = true ;
 action[ Mario.KEY_SPEED ] = true ;
 } } }else{ if( landscape[11+ 0 ][11+ -2 ] != 21 ){ if( landscape[11+ -2 ][11+ -2 ] != -10 ){ action[ Mario.KEY_RIGHT ] = true ;
 if( observation.mayMarioJump() ){ action[ Mario.KEY_JUMP ] = true ;
 } } } } }else{ if( observation.mayMarioJump() ){ if( landscape[11+ 1 ][11+ 0 ] != 0 ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_DOWN ] = false ;
 if( enemies[11+ 0 ][11+ -1 ] != Sprite.KIND_SPIKY_WINGED ){ action[ Mario.KEY_SPEED ] = true ;
 } }else{ action[ Mario.KEY_JUMP ] = true ;
 } if( observation.mayMarioJump() ){ action[ Mario.KEY_LEFT ] = false ;
 } } }else{ if( enemies[11+ 2 ][11+ -2 ] != Sprite.KIND_GREEN_KOOPA_WINGED ){ if( enemies[11+ 1 ][11+ 0 ] != Sprite.KIND_SPIKY_WINGED ){ if( landscape[11+ -2 ][11+ -1 ] != -10 ){ action[ Mario.KEY_RIGHT ] = false ;
 }else{ if( enemies[11+ -1 ][11+ 1 ] != Sprite.KIND_SPIKY_WINGED ){ action[ Mario.KEY_SPEED ] = false ;
 } action[ Mario.KEY_DOWN ] = true ;
