...
//                        show(cur_char);
	...
	byte[][] landscape = observation.getLevelSceneObservation();// default: ZLevelScene = 1  
	 ...
	 if( enemies[11+ -1 ][11+ 2 ] != Sprite.KIND_GREEN_KOOPA ){ if( observation.isMarioOnGround() ){ if( enemies[11+ 1 ][11+ 1 ] != Sprite.KIND_SPIKY ){ action[ Mario.KEY_RIGHT ] = false ;
 ...
 } if( landscape[11+ -2 ][11+ -2 ] != 0 ){ action[ Mario.KEY_DOWN ] = true ;
 } } 	
	//Begin of BGPAgent
	return action;
    }
