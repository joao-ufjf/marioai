...
//                        show(cur_char);
	...
	byte[][] landscape = observation.getLevelSceneObservation();// default: ZLevelScene = 1  
	 ...
	 if( observation.isMarioOnGround() ){ if( observation.mayMarioJump() ){ if( observation.isMarioOnGround() ){ if( observation.mayMarioJump() ){ if( observation.isMarioOnGround() ){ if( enemies[11+ 0 ][11+ 1 ] != Sprite.KIND_SPIKY ){ action[ Mario.KEY_DOWN ] = true ;
 ...
 action[ Mario.KEY_SPEED ] = true ;
 } } }else{ if( landscape[11+ 0 ][11+ -2 ] != 21 ){ if( landscape[11+ -2 ][11+ -2 ] != 21 ){ action[ Mario.KEY_RIGHT ] = true ;
