...
//                        show(cur_char);
	...
	byte[][] landscape = observation.getLevelSceneObservation();// default: ZLevelScene = 1  
	 ...
	 if( observation.isMarioOnGround() ){ if( observation.mayMarioJump() ){ if( observation.isMarioOnGround() ){ if( observation.isMarioOnGround() ){ if( landscape[11+ -2 ][11+ -2 ] != -11 ){ action[ Mario.KEY_JUMP ] = true ;
 } }else{ action[ Mario.KEY_SPEED ] = false ;
 action[ Mario.KEY_RIGHT ] = false ;
 action[ Mario.KEY_DOWN ] = false ;
 if( enemies[11+ 2 ][11+ -2 ] != Sprite.KIND_RED_KOOPA_WINGED ){ action[ Mario.KEY_DOWN ] = true ;
 } } }else{ if( enemies[11+ -2 ][11+ 2 ] != Sprite.KIND_RED_KOOPA ){ action[ Mario.KEY_DOWN ] = true ;
 action[ Mario.KEY_SPEED ] = true ;
 } } }else{ if( landscape[11+ 0 ][11+ -2 ] != 21 ){ if( landscape[11+ -2 ][11+ -2 ] != -11 ){ action[ Mario.KEY_RIGHT ] = true ;
 ...
 } } }else{ if( enemies[11+ 2 ][11+ -2 ] != Sprite.KIND_GREEN_KOOPA_WINGED ){ if( enemies[11+ 1 ][11+ 0 ] != Sprite.KIND_RED_KOOPA_WINGED ){ action[ Mario.KEY_LEFT ] = false ;
 } }else{ action[ Mario.KEY_JUMP ] = true ;
 } } } 	
	//Begin of BGPAgent
	return action;
