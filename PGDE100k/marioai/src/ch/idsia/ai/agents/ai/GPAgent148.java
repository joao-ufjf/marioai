...
//                        show(cur_char);
 ...
 } } }else{ if( enemies[11+ -2 ][11+ 2 ] != Sprite.KIND_GREEN_KOOPA_WINGED ){ action[ Mario.KEY_DOWN ] = true ;
 action[ Mario.KEY_SPEED ] = true ;
 } } }else{ if( landscape[11+ 0 ][11+ -2 ] != 21 ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_RIGHT ] = true ;
 ...
 } } }else{ if( enemies[11+ 2 ][11+ -2 ] != Sprite.KIND_GREEN_KOOPA_WINGED ){ if( enemies[11+ -2 ][11+ 0 ] != Sprite.KIND_SPIKY_WINGED ){ action[ Mario.KEY_LEFT ] = true ;
 } }else{ action[ Mario.KEY_JUMP ] = true ;
 } } } 	
	//Begin of BGPAgent
	return action;
