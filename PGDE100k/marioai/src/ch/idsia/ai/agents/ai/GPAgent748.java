 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent748 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 action[ Mario.KEY_RIGHT ] = false ;
 action[ Mario.KEY_SPEED ] = false ;
 } } if( landscape[11+ 0 ][11+ 1 ] != 1 ){ if( observation.mayMarioJump() ){ if( landscape[11+ -1 ][11+ 0 ] != 1 ){ action[ Mario.KEY_JUMP ] = true ;
