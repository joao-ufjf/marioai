...
//                        show(cur_char);
 ...
 if( landscape[11+ -2 ][11+ -2 ] != 20 ){ action[ Mario.KEY_LEFT ] = false ;
 } } }else{ if( enemies[11+ -2 ][11+ 2 ] != Sprite.KIND_RED_KOOPA ){ if( enemies[11+ 2 ][11+ 2 ] != Sprite.KIND_SPIKY ){ action[ Mario.KEY_SPEED ] = false ;
