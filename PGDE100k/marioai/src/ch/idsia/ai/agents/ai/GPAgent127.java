...
//                        show(cur_char);
	...
	byte[][] landscape = observation.getLevelSceneObservation();// default: ZLevelScene = 1  
	 ...
	 if( observation.isMarioOnGround() ){ if( observation.mayMarioJump() ){ if( observation.isMarioOnGround() ){ if( landscape[11+ -2 ][11+ -2 ] != 0 ){ action[ Mario.KEY_SPEED ] = true ;
 ...
 } } } } }else{ if( observation.mayMarioJump() ){ if( landscape[11+ 1 ][11+ 0 ] != 0 ){ action[ Mario.KEY_LEFT ] = true ;
