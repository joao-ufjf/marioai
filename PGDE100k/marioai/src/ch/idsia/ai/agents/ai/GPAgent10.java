...
//                        show(cur_char);
	...
	byte[][] landscape = observation.getLevelSceneObservation();// default: ZLevelScene = 1  
	 ...
	 if( landscape[11+ 0 ][11+ 1 ] != 0 ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_DOWN ] = false ;
 action[ Mario.KEY_JUMP ] = false ;
 }else{ if( landscape[11+ 0 ][11+ 1 ] != 21 ){ action[ Mario.KEY_JUMP ] = false ;
 }else{ action[ Mario.KEY_DOWN ] = false ;
 } } if( landscape[11+ 0 ][11+ -1 ] != -11 ){ if( landscape[11+ 1 ][11+ 0 ] != 0 ){ action[ Mario.KEY_DOWN ] = false ;
 }else{ action[ Mario.KEY_SPEED ] = false ;
 } } if( landscape[11+ -1 ][11+ 1 ] != 21 ){ if( observation.isMarioOnGround() ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_RIGHT ] = true ;
 } }else{ action[ Mario.KEY_SPEED ] = false ;
