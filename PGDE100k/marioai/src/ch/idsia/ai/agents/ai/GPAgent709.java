 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent709 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 } if( observation.mayMarioJump() ){ if( landscape[11+ -1 ][11+ 1 ] != 1 ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_JUMP ] = false ;
 ...
 action[ Mario.KEY_JUMP ] = true ;
 } }else{ if( enemies[11+ -1 ][11+ -1 ] != 1 ){ if( observation.isMarioOnGround() ){ if( enemies[11+ -1 ][11+ -1 ] != 1 ){ action[ Mario.KEY_LEFT ] = false ;
 ...
 action[ Mario.KEY_LEFT ] = false ;
 action[ Mario.KEY_DOWN ] = false ;
 } if( landscape[11+ 0 ][11+ 0 ] != 1 ){ if( enemies[11+ -1 ][11+ 1 ] != 1 ){ action[ Mario.KEY_DOWN ] = false ;
 ...
 action[ Mario.KEY_SPEED ] = true ;
 } } if( observation.mayMarioJump() ){ if( enemies[11+ 0 ][11+ -1 ] != 1 ){ if( enemies[11+ 0 ][11+ 0 ] != 1 ){ action[ Mario.KEY_JUMP ] = true ;
 }else{ action[ Mario.KEY_SPEED ] = true ;
 } action[ Mario.KEY_SPEED ] = true ;
 action[ Mario.KEY_SPEED ] = true ;
 }else{ if( landscape[11+ 1 ][11+ -1 ] != 1 ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_SPEED ] = false ;
