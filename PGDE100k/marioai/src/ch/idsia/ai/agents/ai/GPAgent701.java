 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent701 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 if( landscape[11+ 1 ][11+ -1 ] != 1 ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_RIGHT ] = false ;
 ...
 } }else{ if( enemies[11+ -1 ][11+ 0 ] != 1 ){ if( observation.mayMarioJump() ){ if( enemies[11+ 0 ][11+ 1 ] != 1 ){ if( observation.isMarioOnGround() ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_LEFT ] = true ;
