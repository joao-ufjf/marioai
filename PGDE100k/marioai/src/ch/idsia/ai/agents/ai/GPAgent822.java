 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent822 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 }else{ if( landscape[11+ 0 ][11+ 1 ] != 1 ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_RIGHT ] = true ;
 ...
 } } } if( observation.isMarioOnGround() ){ if( landscape[11+ 0 ][11+ -1 ] != 1 ){ if( enemies[11+ -1 ][11+ -1 ] != 1 ){ action[ Mario.KEY_RIGHT ] = false ;
