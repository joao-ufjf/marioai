...
//                        show(cur_char);
 ...
 } } }else{ if( enemies[11+ -2 ][11+ 2 ] != Sprite.KIND_GOOMBA ){ action[ Mario.KEY_DOWN ] = true ;
 action[ Mario.KEY_SPEED ] = true ;
 } } }else{ if( observation.mayMarioJump() ){ if( landscape[11+ -2 ][11+ -2 ] != -11 ){ action[ Mario.KEY_LEFT ] = true ;
 if( observation.mayMarioJump() ){ action[ Mario.KEY_JUMP ] = true ;
 action[ Mario.KEY_JUMP ] = false ;
 } } } } }else{ if( observation.mayMarioJump() ){ if( landscape[11+ -2 ][11+ -1 ] != -10 ){ if( observation.mayMarioJump() ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_JUMP ] = true ;
