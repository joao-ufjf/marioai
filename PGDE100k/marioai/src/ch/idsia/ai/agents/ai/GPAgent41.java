...
//                        show(cur_char);
	...
	byte[][] landscape = observation.getLevelSceneObservation();// default: ZLevelScene = 1  
	 ...
	 if( enemies[11+ -1 ][11+ 0 ] != Sprite.KIND_RED_KOOPA_WINGED ){ if( enemies[11+ 0 ][11+ 2 ] != Sprite.KIND_SPIKY_WINGED ){ action[ Mario.KEY_LEFT ] = false ;
 } }else{ if( enemies[11+ -2 ][11+ -2 ] != Sprite.KIND_SPIKY ){ action[ Mario.KEY_SPEED ] = false ;
 } } 	
	//Begin of BGPAgent
	return action;
    }
