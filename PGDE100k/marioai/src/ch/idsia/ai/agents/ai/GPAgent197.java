...
//                        show(cur_char);
 ...
 if( observation.isMarioOnGround() ){ if( landscape[11+ 2 ][11+ 1 ] != 20 ){ if( observation.isMarioOnGround() ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_JUMP ] = true ;
 ...
 } } } }else{ if( observation.isMarioOnGround() ){ if( enemies[11+ 1 ][11+ 0 ] != Sprite.KIND_RED_KOOPA ){ if( landscape[11+ -1 ][11+ 2 ] != 0 ){ action[ Mario.KEY_RIGHT ] = true ;
