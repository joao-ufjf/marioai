...
//                        show(cur_char);
	...
	byte[][] landscape = observation.getLevelSceneObservation();// default: ZLevelScene = 1  
	 ...
	 if( landscape[11+ -2 ][11+ 2 ] != 16 ){ if( observation.isMarioOnGround() ){ if( landscape[11+ 2 ][11+ 1 ] != 0 ){ if( enemies[11+ -2 ][11+ 2 ] != Sprite.KIND_GREEN_KOOPA ){ action[ Mario.KEY_LEFT ] = true ;
 } }else{ if( landscape[11+ -1 ][11+ 0 ] != -10 ){ if( landscape[11+ 1 ][11+ 0 ] != 16 ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_SPEED ] = true ;
 } } }else{ action[ Mario.KEY_JUMP ] = true ;
 } } }else{ if( enemies[11+ 2 ][11+ 0 ] != Sprite.KIND_GOOMBA_WINGED ){ action[ Mario.KEY_LEFT ] = false ;
 if( enemies[11+ -1 ][11+ -2 ] != Sprite.KIND_BULLET_BILL ){ action[ Mario.KEY_JUMP ] = true ;
