...
//                        show(cur_char);
 ...
 }else{ if( enemies[11+ -1 ][11+ -1 ] != Sprite.KIND_SPIKY ){ action[ Mario.KEY_SPEED ] = false ;
 }else{ if( observation.mayMarioJump() ){ action[ Mario.KEY_JUMP ] = true ;
 } } } if( enemies[11+ -1 ][11+ 0 ] != Sprite.KIND_RED_KOOPA_WINGED ){ if( landscape[11+ 1 ][11+ 0 ] != 16 ){ action[ Mario.KEY_LEFT ] = false ;
 }else{ action[ Mario.KEY_DOWN ] = true ;
 } }else{ if( enemies[11+ 0 ][11+ 1 ] != Sprite.KIND_BULLET_BILL ){ action[ Mario.KEY_DOWN ] = false ;
 ...
 } }else{ if( landscape[11+ -1 ][11+ 2 ] != 21 ){ if( landscape[11+ 0 ][11+ -1 ] != 0 ){ action[ Mario.KEY_LEFT ] = true ;
 } }else{ if( observation.mayMarioJump() ){ action[ Mario.KEY_DOWN ] = true ;
 }else{ action[ Mario.KEY_SPEED ] = true ;
 } } } if( enemies[11+ -2 ][11+ -2 ] != Sprite.KIND_GREEN_KOOPA_WINGED ){ if( landscape[11+ -1 ][11+ 1 ] != 21 ){ action[ Mario.KEY_SPEED ] = false ;
 } if( landscape[11+ -2 ][11+ 2 ] != -11 ){ action[ Mario.KEY_RIGHT ] = true ;
 action[ Mario.KEY_RIGHT ] = false ;
 } }else{ action[ Mario.KEY_JUMP ] = true ;
 action[ Mario.KEY_JUMP ] = true ;
 action[ Mario.KEY_JUMP ] = true ;
 if( enemies[11+ -1 ][11+ 0 ] != Sprite.KIND_SPIKY_WINGED ){ action[ Mario.KEY_JUMP ] = true ;
