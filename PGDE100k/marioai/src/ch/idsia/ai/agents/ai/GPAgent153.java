...
//                        show(cur_char);
	...
	byte[][] landscape = observation.getLevelSceneObservation();// default: ZLevelScene = 1  
	 ...
	 if( observation.mayMarioJump() ){ if( observation.isMarioOnGround() ){ if( observation.mayMarioJump() ){ if( landscape[11+ 2 ][11+ 1 ] != 16 ){ if( landscape[11+ -1 ][11+ 1 ] != -10 ){ action[ Mario.KEY_LEFT ] = true ;
 ...
 } } }else{ if( landscape[11+ -1 ][11+ -2 ] != 20 ){ if( enemies[11+ -2 ][11+ 0 ] != Sprite.KIND_BULLET_BILL ){ action[ Mario.KEY_DOWN ] = false ;
 }else{ action[ Mario.KEY_RIGHT ] = true ;
 } action[ Mario.KEY_DOWN ] = true ;
 } } if( landscape[11+ -2 ][11+ -2 ] != 0 ){ if( observation.mayMarioJump() ){ if( enemies[11+ 1 ][11+ -1 ] != Sprite.KIND_GOOMBA_WINGED ){ action[ Mario.KEY_DOWN ] = false ;
 }else{ action[ Mario.KEY_SPEED ] = false ;
 } if( observation.mayMarioJump() ){ action[ Mario.KEY_RIGHT ] = true ;
 } } } }else{ if( observation.isMarioOnGround() ){ if( landscape[11+ -2 ][11+ -2 ] != 20 ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_RIGHT ] = false ;
 ...
 action[ Mario.KEY_LEFT ] = true ;
 if( enemies[11+ 1 ][11+ 2 ] != Sprite.KIND_RED_KOOPA ){ action[ Mario.KEY_JUMP ] = false ;
 } }else{ action[ Mario.KEY_SPEED ] = true ;
