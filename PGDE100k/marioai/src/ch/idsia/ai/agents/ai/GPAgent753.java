 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent753 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 if( landscape[11+ 1 ][11+ -1 ] != 1 ){ if( landscape[11+ 1 ][11+ 0 ] != 1 ){ if( landscape[11+ 0 ][11+ 1 ] != 1 ){ action[ Mario.KEY_JUMP ] = false ;
 ...
 action[ Mario.KEY_LEFT ] = false ;
 } if( observation.isMarioOnGround() ){ if( landscape[11+ -1 ][11+ -1 ] != 1 ){ action[ Mario.KEY_SPEED ] = true ;
 }else{ if( observation.mayMarioJump() ){ action[ Mario.KEY_SPEED ] = false ;
 }else{ action[ Mario.KEY_JUMP ] = true ;
 } action[ Mario.KEY_JUMP ] = false ;
 action[ Mario.KEY_SPEED ] = true ;
 } }else{ action[ Mario.KEY_JUMP ] = true ;
 } if( observation.isMarioOnGround() ){ if( observation.mayMarioJump() ){ if( landscape[11+ -1 ][11+ 1 ] != 1 ){ action[ Mario.KEY_JUMP ] = true ;
 action[ Mario.KEY_LEFT ] = false ;
