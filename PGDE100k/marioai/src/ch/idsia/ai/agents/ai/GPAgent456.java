 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent456 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
	...
	byte[][] landscape = observation.getLevelSceneObservation();// default: ZLevelScene = 1  
	 ...
	 if( landscape[11+ 1 ][11+ -1 ] != 1 ){ if( enemies[11+ 1 ][11+ -1 ] != 1 ){ action[ Mario.KEY_SPEED ] = false ;
 }else{ action[ Mario.KEY_RIGHT ] = false ;
 } action[ Mario.KEY_LEFT ] = true ;
 action[ Mario.KEY_LEFT ] = true ;
 if( observation.mayMarioJump() ){ if( enemies[11+ 1 ][11+ 1 ] != 1 ){ action[ Mario.KEY_DOWN ] = false ;
 }else{ action[ Mario.KEY_DOWN ] = true ;
 } }else{ action[ Mario.KEY_RIGHT ] = false ;
 action[ Mario.KEY_RIGHT ] = false ;
 } if( enemies[11+ -1 ][11+ 0 ] != 1 ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_RIGHT ] = false ;
 ...
 } }else{ if( observation.isMarioOnGround() ){ if( enemies[11+ 1 ][11+ -1 ] != 1 ){ action[ Mario.KEY_RIGHT ] = false ;
 action[ Mario.KEY_LEFT ] = true ;
 ...
 action[ Mario.KEY_JUMP ] = true ;
 } if( observation.mayMarioJump() ){ if( enemies[11+ -1 ][11+ -1 ] != 1 ){ action[ Mario.KEY_LEFT ] = false ;
 action[ Mario.KEY_JUMP ] = true ;
 }else{ if( enemies[11+ 0 ][11+ 0 ] != 1 ){ action[ Mario.KEY_RIGHT ] = false ;
 }else{ action[ Mario.KEY_RIGHT ] = false ;
 ...
 } } }else{ if( landscape[11+ 0 ][11+ 0 ] != 1 ){ if( observation.isMarioOnGround() ){ if( landscape[11+ 0 ][11+ 1 ] != 1 ){ action[ Mario.KEY_RIGHT ] = false ;
 }else{ action[ Mario.KEY_JUMP ] = false ;
 } }else{ if( enemies[11+ -1 ][11+ -1 ] != 1 ){ action[ Mario.KEY_SPEED ] = false ;
 }else{ action[ Mario.KEY_JUMP ] = false ;
 } } }else{ if( landscape[11+ 0 ][11+ 1 ] != 1 ){ if( enemies[11+ -1 ][11+ 0 ] != 1 ){ action[ Mario.KEY_SPEED ] = false ;
 }else{ action[ Mario.KEY_LEFT ] = false ;
 } }else{ if( observation.isMarioOnGround() ){ action[ Mario.KEY_DOWN ] = true ;
 }else{ action[ Mario.KEY_LEFT ] = false ;
 } } } } if( landscape[11+ -1 ][11+ -1 ] != 1 ){ if( observation.isMarioOnGround() ){ if( landscape[11+ 1 ][11+ 1 ] != 1 ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_LEFT ] = true ;
 }else{ action[ Mario.KEY_JUMP ] = false ;
 } }else{ action[ Mario.KEY_LEFT ] = false ;
 action[ Mario.KEY_LEFT ] = true ;
 } }else{ if( enemies[11+ 0 ][11+ 1 ] != 1 ){ if( landscape[11+ 1 ][11+ -1 ] != 1 ){ action[ Mario.KEY_SPEED ] = true ;
 }else{ action[ Mario.KEY_RIGHT ] = true ;
 } }else{ action[ Mario.KEY_DOWN ] = true ;
 action[ Mario.KEY_SPEED ] = false ;
 } } }else{ if( enemies[11+ -1 ][11+ -1 ] != 1 ){ action[ Mario.KEY_LEFT ] = true ;
 action[ Mario.KEY_LEFT ] = true ;
 action[ Mario.KEY_RIGHT ] = true ;
 action[ Mario.KEY_LEFT ] = false ;
 }else{ if( enemies[11+ 0 ][11+ -1 ] != 1 ){ if( enemies[11+ 1 ][11+ -1 ] != 1 ){ action[ Mario.KEY_JUMP ] = true ;
 ...
 action[ Mario.KEY_LEFT ] = false ;
 } if( observation.mayMarioJump() ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_DOWN ] = true ;
 ...
 } } } if( enemies[11+ -1 ][11+ 0 ] != 1 ){ if( observation.mayMarioJump() ){ if( enemies[11+ -1 ][11+ 0 ] != 1 ){ action[ Mario.KEY_SPEED ] = true ;
 }else{ action[ Mario.KEY_SPEED ] = true ;
 } }else{ action[ Mario.KEY_SPEED ] = false ;
 action[ Mario.KEY_RIGHT ] = true ;
 ...
 } }else{ if( observation.isMarioOnGround() ){ if( observation.mayMarioJump() ){ if( enemies[11+ 1 ][11+ 0 ] != 1 ){ action[ Mario.KEY_DOWN ] = true ;
 }else{ action[ Mario.KEY_LEFT ] = false ;
 } }else{ action[ Mario.KEY_SPEED ] = true ;
 action[ Mario.KEY_JUMP ] = false ;
