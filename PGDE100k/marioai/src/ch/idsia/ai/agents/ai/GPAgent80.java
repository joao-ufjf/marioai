...
//                        show(cur_char);
 ...
 } } } } }else{ if( observation.mayMarioJump() ){ if( landscape[11+ -2 ][11+ -1 ] != -10 ){ if( observation.mayMarioJump() ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_DOWN ] = true ;
 ...
 } if( landscape[11+ -1 ][11+ -1 ] != 0 ){ action[ Mario.KEY_DOWN ] = false ;
 }else{ action[ Mario.KEY_RIGHT ] = false ;
 } } } } 	
	//Begin of BGPAgent
	return action;
