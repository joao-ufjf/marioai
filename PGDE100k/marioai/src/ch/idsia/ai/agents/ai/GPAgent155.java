...
//                        show(cur_char);
 ...
 if( enemies[11+ -2 ][11+ 0 ] != Sprite.KIND_SPIKY_WINGED ){ if( landscape[11+ 2 ][11+ -2 ] != 16 ){ if( enemies[11+ -1 ][11+ -2 ] != Sprite.KIND_RED_KOOPA_WINGED ){ action[ Mario.KEY_LEFT ] = true ;
 }else{ action[ Mario.KEY_LEFT ] = true ;
 } }else{ action[ Mario.KEY_DOWN ] = true ;
 } if( enemies[11+ 2 ][11+ 2 ] != Sprite.KIND_RED_KOOPA_WINGED ){ action[ Mario.KEY_JUMP ] = false ;
 action[ Mario.KEY_SPEED ] = false ;
 }else{ action[ Mario.KEY_DOWN ] = false ;
 action[ Mario.KEY_DOWN ] = false ;
 } } action[ Mario.KEY_RIGHT ] = false ;
 if( landscape[11+ 1 ][11+ 0 ] != 16 ){ action[ Mario.KEY_RIGHT ] = false ;
 } if( enemies[11+ 2 ][11+ 0 ] != Sprite.KIND_RED_KOOPA ){ action[ Mario.KEY_RIGHT ] = true ;
 }else{ action[ Mario.KEY_JUMP ] = true ;
 } if( landscape[11+ 0 ][11+ -1 ] != -10 ){ if( enemies[11+ 1 ][11+ -1 ] != Sprite.KIND_SPIKY ){ if( landscape[11+ 1 ][11+ 1 ] != 21 ){ action[ Mario.KEY_RIGHT ] = false ;
