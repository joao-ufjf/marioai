...
//                        show(cur_char);
 ...
 } if( enemies[11+ 0 ][11+ 2 ] != Sprite.KIND_GOOMBA ){ action[ Mario.KEY_LEFT ] = false ;
 } if( enemies[11+ 1 ][11+ -2 ] != Sprite.KIND_SPIKY ){ if( landscape[11+ 0 ][11+ -2 ] != -11 ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_DOWN ] = true ;
