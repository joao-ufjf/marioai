 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent797 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 if( landscape[11+ 1 ][11+ 1 ] != 1 ){ if( enemies[11+ 1 ][11+ 0 ] != 1 ){ action[ Mario.KEY_SPEED ] = true ;
 ...
 } } }else{ if( landscape[11+ 0 ][11+ 1 ] != 1 ){ if( landscape[11+ -1 ][11+ 0 ] != 1 ){ action[ Mario.KEY_DOWN ] = false ;
 }else{ action[ Mario.KEY_DOWN ] = false ;
