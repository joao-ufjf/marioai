...
//                        show(cur_char);
 ...
 if( observation.isMarioOnGround() ){ if( landscape[11+ -2 ][11+ 1 ] != 20 ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_DOWN ] = false ;
 } } }else{ action[ Mario.KEY_RIGHT ] = false ;
 if( landscape[11+ -2 ][11+ 1 ] != 20 ){ action[ Mario.KEY_LEFT ] = false ;
 } } action[ Mario.KEY_LEFT ] = true ;
 } }else{ if( observation.isMarioOnGround() ){ if( observation.mayMarioJump() ){ if( observation.mayMarioJump() ){ if( observation.isMarioOnGround() ){ if( landscape[11+ -2 ][11+ -1 ] != 20 ){ action[ Mario.KEY_LEFT ] = false ;
