...
//                        show(cur_char);
 ...
 }else{ if( landscape[11+ 0 ][11+ 1 ] != 21 ){ action[ Mario.KEY_SPEED ] = false ;
 }else{ action[ Mario.KEY_DOWN ] = false ;
 } } if( observation.mayMarioJump() ){ if( landscape[11+ 1 ][11+ 0 ] != 0 ){ action[ Mario.KEY_SPEED ] = true ;
 }else{ action[ Mario.KEY_SPEED ] = false ;
 } } if( landscape[11+ 0 ][11+ 1 ] != -11 ){ action[ Mario.KEY_DOWN ] = false ;
