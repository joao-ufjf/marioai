...
//                        show(cur_char);
	...
	byte[][] landscape = observation.getLevelSceneObservation();// default: ZLevelScene = 1  
	 ...
	 if( observation.isMarioOnGround() ){ if( observation.mayMarioJump() ){ if( observation.isMarioOnGround() ){ if( landscape[11+ -2 ][11+ -2 ] != 0 ){ action[ Mario.KEY_SPEED ] = false ;
 action[ Mario.KEY_DOWN ] = true ;
 }else{ if( landscape[11+ 1 ][11+ 1 ] != 0 ){ action[ Mario.KEY_JUMP ] = true ;
 } } }else{ if( enemies[11+ 1 ][11+ 2 ] != Sprite.KIND_RED_KOOPA ){ action[ Mario.KEY_DOWN ] = true ;
 action[ Mario.KEY_SPEED ] = true ;
 } } }else{ if( landscape[11+ 0 ][11+ 2 ] != 21 ){ if( landscape[11+ -2 ][11+ -2 ] != -11 ){ action[ Mario.KEY_SPEED ] = true ;
 if( observation.mayMarioJump() ){ action[ Mario.KEY_JUMP ] = true ;
 } } } } }else{ if( observation.mayMarioJump() ){ if( landscape[11+ 1 ][11+ 0 ] != 0 ){ if( enemies[11+ 2 ][11+ -2 ] != Sprite.KIND_SPIKY_WINGED ){ if( enemies[11+ -1 ][11+ -2 ] != Sprite.KIND_SPIKY ){ if( observation.mayMarioJump() ){ if( enemies[11+ -1 ][11+ -2 ] != Sprite.KIND_SPIKY ){ action[ Mario.KEY_JUMP ] = false ;
 } } }else{ if( landscape[11+ 0 ][11+ -1 ] != 21 ){ if( enemies[11+ -2 ][11+ -2 ] != Sprite.KIND_BULLET_BILL ){ action[ Mario.KEY_JUMP ] = true ;
 }else{ action[ Mario.KEY_DOWN ] = false ;
 } }else{ action[ Mario.KEY_JUMP ] = true ;
 action[ Mario.KEY_DOWN ] = false ;
 } } }else{ if( landscape[11+ -2 ][11+ 2 ] != -11 ){ action[ Mario.KEY_RIGHT ] = false ;
 }else{ if( observation.isMarioOnGround() ){ action[ Mario.KEY_RIGHT ] = false ;
 } } action[ Mario.KEY_JUMP ] = false ;
 } } }else{ if( enemies[11+ 2 ][11+ -2 ] != Sprite.KIND_GREEN_KOOPA_WINGED ){ if( enemies[11+ 1 ][11+ 0 ] != Sprite.KIND_SPIKY_WINGED ){ action[ Mario.KEY_LEFT ] = true ;
 } }else{ action[ Mario.KEY_JUMP ] = true ;
 } } } 	
	//Begin of BGPAgent
	return action;
