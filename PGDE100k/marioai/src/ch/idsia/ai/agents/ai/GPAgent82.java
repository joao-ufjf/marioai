...
//                        show(cur_char);
 ...
 if( landscape[11+ 1 ][11+ -1 ] != 0 ){ action[ Mario.KEY_DOWN ] = true ;
 action[ Mario.KEY_DOWN ] = false ;
 action[ Mario.KEY_LEFT ] = false ;
 }else{ if( landscape[11+ 1 ][11+ 2 ] != 16 ){ action[ Mario.KEY_RIGHT ] = true ;
 } } } if( observation.mayMarioJump() ){ if( observation.isMarioOnGround() ){ if( observation.mayMarioJump() ){ if( enemies[11+ 1 ][11+ 0 ] != Sprite.KIND_SPIKY_WINGED ){ action[ Mario.KEY_RIGHT ] = true ;
 } action[ Mario.KEY_LEFT ] = true ;
 action[ Mario.KEY_LEFT ] = true ;
 } } }else{ if( landscape[11+ 1 ][11+ 0 ] != -11 ){ if( enemies[11+ 2 ][11+ 2 ] != Sprite.KIND_GREEN_KOOPA ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_RIGHT ] = true ;
 } }else{ if( landscape[11+ -2 ][11+ 0 ] != -10 ){ action[ Mario.KEY_JUMP ] = true ;
 } } } if( enemies[11+ 2 ][11+ 0 ] != Sprite.KIND_GREEN_KOOPA_WINGED ){ if( enemies[11+ -2 ][11+ 2 ] != Sprite.KIND_RED_KOOPA ){ action[ Mario.KEY_LEFT ] = true ;
 }else{ action[ Mario.KEY_RIGHT ] = false ;
 } action[ Mario.KEY_JUMP ] = false ;
 action[ Mario.KEY_DOWN ] = true ;
 } } if( enemies[11+ 0 ][11+ -2 ] != Sprite.KIND_RED_KOOPA ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_RIGHT ] = true ;
 }else{ action[ Mario.KEY_RIGHT ] = false ;
 } }else{ if( enemies[11+ 0 ][11+ -1 ] != Sprite.KIND_GOOMBA ){ action[ Mario.KEY_DOWN ] = false ;
