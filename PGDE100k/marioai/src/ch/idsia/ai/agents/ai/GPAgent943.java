 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent943 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 } if( landscape[11+ 1 ][11+ 0 ] != 1 ){ if( landscape[11+ -1 ][11+ -1 ] != 1 ){ action[ Mario.KEY_JUMP ] = false ;
 }else{ action[ Mario.KEY_SPEED ] = false ;
 } }else{ action[ Mario.KEY_JUMP ] = true ;
 } action[ Mario.KEY_LEFT ] = true ;
 } }else{ if( observation.isMarioOnGround() ){ if( observation.isMarioOnGround() ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_RIGHT ] = true ;
 ...
 }else{ if( observation.mayMarioJump() ){ if( enemies[11+ -1 ][11+ 0 ] != 1 ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_SPEED ] = true ;
 action[ Mario.KEY_SPEED ] = true ;
