...
//                        show(cur_char);
 ...
 }else{ if( landscape[11+ -1 ][11+ -1 ] != -10 ){ if( observation.mayMarioJump() ){ if( observation.mayMarioJump() ){ if( observation.mayMarioJump() ){ if( enemies[11+ 0 ][11+ -2 ] != Sprite.KIND_RED_KOOPA_WINGED ){ action[ Mario.KEY_DOWN ] = true ;
