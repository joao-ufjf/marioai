...
//                        show(cur_char);
	...
	byte[][] landscape = observation.getLevelSceneObservation();// default: ZLevelScene = 1  
	 ...
	 if( landscape[11+ -2 ][11+ 2 ] != 16 ){ if( observation.isMarioOnGround() ){ if( landscape[11+ 2 ][11+ 1 ] != 0 ){ action[ Mario.KEY_SPEED ] = true ;
 }else{ if( landscape[11+ -1 ][11+ 0 ] != -10 ){ if( landscape[11+ 1 ][11+ 0 ] != 16 ){ if( observation.isMarioOnGround() ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_DOWN ] = false ;
