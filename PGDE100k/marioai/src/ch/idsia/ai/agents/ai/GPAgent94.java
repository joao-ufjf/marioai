...
//                        show(cur_char);
 ...
 if( landscape[11+ -1 ][11+ -2 ] != -11 ){ if( landscape[11+ 1 ][11+ -1 ] != 21 ){ action[ Mario.KEY_JUMP ] = false ;
 }else{ if( landscape[11+ 0 ][11+ -2 ] != -11 ){ if( enemies[11+ -2 ][11+ -1 ] != Sprite.KIND_GOOMBA ){ if( enemies[11+ 1 ][11+ -1 ] != Sprite.KIND_BULLET_BILL ){ action[ Mario.KEY_LEFT ] = false ;
 ...
 } } }else{ if( enemies[11+ -1 ][11+ 2 ] != Sprite.KIND_GREEN_KOOPA_WINGED ){ if( enemies[11+ 2 ][11+ 0 ] != Sprite.KIND_GREEN_KOOPA_WINGED ){ if( landscape[11+ -1 ][11+ -1 ] != -10 ){ if( enemies[11+ -1 ][11+ 1 ] != Sprite.KIND_SPIKY ){ action[ Mario.KEY_LEFT ] = true ;
