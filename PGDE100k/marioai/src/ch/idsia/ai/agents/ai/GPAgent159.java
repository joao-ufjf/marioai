...
//                        show(cur_char);
 ...
 }else{ if( landscape[11+ 1 ][11+ 1 ] != 0 ){ if( enemies[11+ 2 ][11+ -2 ] != Sprite.KIND_RED_KOOPA_WINGED ){ action[ Mario.KEY_LEFT ] = true ;
 ...
 } } }else{ if( enemies[11+ 2 ][11+ -2 ] != Sprite.KIND_RED_KOOPA ){ if( landscape[11+ 0 ][11+ 0 ] != 20 ){ action[ Mario.KEY_LEFT ] = true ;
 } }else{ action[ Mario.KEY_JUMP ] = true ;
 } } } 	
	//Begin of BGPAgent
	return action;
