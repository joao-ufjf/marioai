...
//                        show(cur_char);
	...
	byte[][] landscape = observation.getLevelSceneObservation();// default: ZLevelScene = 1  
	 ...
	 if( observation.mayMarioJump() ){ if( observation.isMarioOnGround() ){ if( observation.mayMarioJump() ){ if( observation.mayMarioJump() ){ if( landscape[11+ -1 ][11+ 1 ] != -10 ){ action[ Mario.KEY_LEFT ] = true ;
 ...
 } } }else{ if( observation.isMarioOnGround() ){ if( landscape[11+ -2 ][11+ -2 ] != 0 ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_RIGHT ] = false ;
