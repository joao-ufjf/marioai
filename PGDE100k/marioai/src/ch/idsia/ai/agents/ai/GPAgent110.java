...
//                        show(cur_char);
 ...
 if( observation.isMarioOnGround() ){ if( landscape[11+ -2 ][11+ 1 ] != 20 ){ if( enemies[11+ -1 ][11+ -1 ] != Sprite.KIND_GREEN_KOOPA_WINGED ){ action[ Mario.KEY_DOWN ] = false ;
 } } }else{ action[ Mario.KEY_RIGHT ] = false ;
 action[ Mario.KEY_SPEED ] = false ;
 } action[ Mario.KEY_LEFT ] = true ;
 } }else{ if( observation.isMarioOnGround() ){ if( observation.mayMarioJump() ){ if( landscape[11+ -1 ][11+ -2 ] != -10 ){ if( observation.mayMarioJump() ){ if( enemies[11+ 0 ][11+ 1 ] != Sprite.KIND_BULLET_BILL ){ if( landscape[11+ 2 ][11+ -1 ] != -10 ){ action[ Mario.KEY_JUMP ] = true ;
