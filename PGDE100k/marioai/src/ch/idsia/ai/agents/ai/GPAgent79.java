...
//                        show(cur_char);
	...
	byte[][] landscape = observation.getLevelSceneObservation();// default: ZLevelScene = 1  
	 ...
	 if( observation.isMarioOnGround() ){ if( observation.isMarioOnGround() ){ if( enemies[11+ -1 ][11+ 0 ] != Sprite.KIND_GOOMBA ){ if( landscape[11+ -1 ][11+ -2 ] != 21 ){ if( observation.mayMarioJump() ){ if( enemies[11+ 1 ][11+ 1 ] != Sprite.KIND_SPIKY ){ action[ Mario.KEY_RIGHT ] = true ;
 } } }else{ if( enemies[11+ 1 ][11+ 0 ] != Sprite.KIND_SPIKY_WINGED ){ action[ Mario.KEY_SPEED ] = false ;
 action[ Mario.KEY_RIGHT ] = true ;
 }else{ action[ Mario.KEY_DOWN ] = false ;
 action[ Mario.KEY_RIGHT ] = false ;
 } } }else{ action[ Mario.KEY_JUMP ] = true ;
 if( landscape[11+ -2 ][11+ 0 ] != -10 ){ action[ Mario.KEY_LEFT ] = false ;
 ...
 }else{ if( landscape[11+ 2 ][11+ -2 ] != 0 ){ if( observation.isMarioOnGround() ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_RIGHT ] = true ;
 }else{ action[ Mario.KEY_LEFT ] = true ;
 } } if( enemies[11+ 1 ][11+ 1 ] != Sprite.KIND_GOOMBA ){ if( landscape[11+ 1 ][11+ -1 ] != 21 ){ action[ Mario.KEY_DOWN ] = false ;
 } } }else{ if( landscape[11+ -2 ][11+ 0 ] != 21 ){ action[ Mario.KEY_LEFT ] = true ;
 action[ Mario.KEY_JUMP ] = true ;
 }else{ if( landscape[11+ -2 ][11+ 1 ] != -11 ){ action[ Mario.KEY_RIGHT ] = true ;
 }else{ action[ Mario.KEY_DOWN ] = false ;
 } } if( landscape[11+ 2 ][11+ -1 ] != 21 ){ if( enemies[11+ 2 ][11+ 1 ] != Sprite.KIND_GOOMBA_WINGED ){ action[ Mario.KEY_JUMP ] = true ;
