 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent581 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 }else{ if( observation.mayMarioJump() ){ if( observation.mayMarioJump() ){ if( landscape[11+ 1 ][11+ 0 ] != 1 ){ action[ Mario.KEY_SPEED ] = false ;
 ...
 } if( enemies[11+ -1 ][11+ 1 ] != 1 ){ if( enemies[11+ 0 ][11+ -1 ] != 1 ){ action[ Mario.KEY_RIGHT ] = false ;
