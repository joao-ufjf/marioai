...
//                        show(cur_char);
 ...
 } } } } }else{ if( observation.mayMarioJump() ){ if( landscape[11+ 2 ][11+ 0 ] != -10 ){ if( landscape[11+ 2 ][11+ -1 ] != 0 ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_DOWN ] = true ;
 }else{ action[ Mario.KEY_DOWN ] = true ;
 } } } } if( enemies[11+ -2 ][11+ 0 ] != Sprite.KIND_RED_KOOPA_WINGED ){ if( landscape[11+ 0 ][11+ -2 ] != 16 ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_DOWN ] = true ;
