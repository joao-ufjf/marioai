...
//                        show(cur_char);
 ...
 }else{ if( observation.isMarioOnGround() ){ if( enemies[11+ -2 ][11+ 1 ] != Sprite.KIND_GOOMBA_WINGED ){ if( landscape[11+ -2 ][11+ 2 ] != -10 ){ if( landscape[11+ 1 ][11+ -1 ] != 16 ){ action[ Mario.KEY_SPEED ] = true ;
 } }else{ action[ Mario.KEY_DOWN ] = false ;
 action[ Mario.KEY_SPEED ] = false ;
 } }else{ if( landscape[11+ -1 ][11+ -1 ] != -11 ){ action[ Mario.KEY_RIGHT ] = true ;
 action[ Mario.KEY_RIGHT ] = false ;
 } } }else{ action[ Mario.KEY_LEFT ] = false ;
 action[ Mario.KEY_JUMP ] = true ;
 if( landscape[11+ 2 ][11+ -2 ] != -11 ){ action[ Mario.KEY_DOWN ] = true ;
