...
//                        show(cur_char);
	...
	byte[][] landscape = observation.getLevelSceneObservation();// default: ZLevelScene = 1  
	 ...
	 if( observation.isMarioOnGround() ){ if( enemies[11+ -1 ][11+ -1 ] != Sprite.KIND_GREEN_KOOPA_WINGED ){ action[ Mario.KEY_DOWN ] = false ;
 } } action[ Mario.KEY_RIGHT ] = false ;
 if( observation.isMarioOnGround() ){ if( landscape[11+ 2 ][11+ -2 ] != 20 ){ if( enemies[11+ -2 ][11+ -1 ] != Sprite.KIND_SPIKY ){ action[ Mario.KEY_DOWN ] = false ;
 action[ Mario.KEY_RIGHT ] = true ;
 } }else{ action[ Mario.KEY_RIGHT ] = true ;
 } }else{ if( landscape[11+ -2 ][11+ 2 ] != -11 ){ if( observation.mayMarioJump() ){ if( enemies[11+ -2 ][11+ -1 ] != Sprite.KIND_SPIKY_WINGED ){ if( landscape[11+ -2 ][11+ 0 ] != -10 ){ action[ Mario.KEY_RIGHT ] = false ;
 } }else{ action[ Mario.KEY_DOWN ] = false ;
 } } }else{ if( observation.mayMarioJump() ){ action[ Mario.KEY_JUMP ] = true ;
 } } } if( landscape[11+ -2 ][11+ 2 ] != 16 ){ if( observation.isMarioOnGround() ){ if( enemies[11+ -1 ][11+ -2 ] != Sprite.KIND_RED_KOOPA_WINGED ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_JUMP ] = true ;
 } }else{ if( landscape[11+ 2 ][11+ 1 ] != 20 ){ if( landscape[11+ 1 ][11+ 0 ] != 16 ){ action[ Mario.KEY_RIGHT ] = false ;
