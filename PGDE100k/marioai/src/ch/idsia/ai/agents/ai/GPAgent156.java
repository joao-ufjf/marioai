 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent156 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 } } } } }else{ if( observation.mayMarioJump() ){ if( landscape[11+ 1 ][11+ 0 ] != 20 ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_DOWN ] = false ;
 if( enemies[11+ -1 ][11+ -1 ] != Sprite.KIND_SPIKY_WINGED ){ action[ Mario.KEY_SPEED ] = true ;
