...
//                        show(cur_char);
 ...
 if( observation.isMarioOnGround() ){ if( landscape[11+ 0 ][11+ 1 ] != 20 ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_DOWN ] = false ;
 } } }else{ action[ Mario.KEY_SPEED ] = false ;
 if( landscape[11+ -2 ][11+ -2 ] != 20 ){ action[ Mario.KEY_LEFT ] = false ;
 } } action[ Mario.KEY_DOWN ] = true ;
 } }else{ if( observation.isMarioOnGround() ){ if( observation.isMarioOnGround() ){ if( landscape[11+ 1 ][11+ 1 ] != 21 ){ action[ Mario.KEY_LEFT ] = false ;
 } } if( observation.mayMarioJump() ){ if( observation.mayMarioJump() ){ if( observation.mayMarioJump() ){ if( enemies[11+ -1 ][11+ 1 ] != Sprite.KIND_GOOMBA ){ action[ Mario.KEY_LEFT ] = false ;
