...
//                        show(cur_char);
	...
	byte[][] landscape = observation.getLevelSceneObservation();// default: ZLevelScene = 1  
	 ...
	 if( enemies[11+ 1 ][11+ 2 ] != Sprite.KIND_GREEN_KOOPA_WINGED ){ if( enemies[11+ -2 ][11+ -2 ] != Sprite.KIND_GREEN_KOOPA ){ if( enemies[11+ 2 ][11+ -2 ] != Sprite.KIND_GREEN_KOOPA ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_SPEED ] = true ;
 ...
 } } } } } }else{ if( landscape[11+ -1 ][11+ -2 ] != -10 ){ if( observation.isMarioOnGround() ){ if( landscape[11+ -2 ][11+ -1 ] != 20 ){ action[ Mario.KEY_RIGHT ] = false ;
