...
//                        show(cur_char);
 ...
 }else{ if( observation.mayMarioJump() ){ if( enemies[11+ -2 ][11+ -2 ] != Sprite.KIND_GREEN_KOOPA ){ if( landscape[11+ 1 ][11+ -2 ] != 16 ){ if( enemies[11+ -2 ][11+ -2 ] != Sprite.KIND_GOOMBA ){ if( landscape[11+ 1 ][11+ -1 ] != -10 ){ action[ Mario.KEY_JUMP ] = true ;
 }else{ action[ Mario.KEY_JUMP ] = true ;
 } }else{ if( landscape[11+ -2 ][11+ -1 ] != 16 ){ action[ Mario.KEY_JUMP ] = false ;
 ...
 action[ Mario.KEY_RIGHT ] = true ;
 } } }else{ if( enemies[11+ 0 ][11+ 1 ] != Sprite.KIND_BULLET_BILL ){ action[ Mario.KEY_LEFT ] = false ;
 }else{ if( enemies[11+ 0 ][11+ 2 ] != Sprite.KIND_SPIKY ){ if( enemies[11+ -1 ][11+ 2 ] != Sprite.KIND_GOOMBA ){ action[ Mario.KEY_SPEED ] = true ;
 }else{ action[ Mario.KEY_RIGHT ] = false ;
 } } } } }else{ if( observation.isMarioOnGround() ){ if( landscape[11+ -1 ][11+ -1 ] != -10 ){ if( landscape[11+ -1 ][11+ -2 ] != 16 ){ action[ Mario.KEY_DOWN ] = true ;
