...
//                        show(cur_char);
 ...
 if( landscape[11+ 0 ][11+ -2 ] != 21 ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_SPEED ] = true ;
 ...
 } } if( enemies[11+ 0 ][11+ -2 ] != Sprite.KIND_RED_KOOPA ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_JUMP ] = true ;
 }else{ action[ Mario.KEY_RIGHT ] = false ;
