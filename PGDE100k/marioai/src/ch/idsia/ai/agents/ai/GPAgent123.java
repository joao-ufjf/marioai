...
//                        show(cur_char);
	...
	byte[][] landscape = observation.getLevelSceneObservation();// default: ZLevelScene = 1  
	 ...
	 if( observation.isMarioOnGround() ){ if( observation.mayMarioJump() ){ if( observation.isMarioOnGround() ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_SPEED ] = false ;
 action[ Mario.KEY_DOWN ] = true ;
 }else{ if( landscape[11+ 1 ][11+ 1 ] != 0 ){ action[ Mario.KEY_JUMP ] = true ;
 } } }else{ if( observation.isMarioOnGround() ){ if( observation.mayMarioJump() ){ if( enemies[11+ 1 ][11+ -1 ] != Sprite.KIND_RED_KOOPA_WINGED ){ action[ Mario.KEY_SPEED ] = false ;
 } }else{ if( landscape[11+ 1 ][11+ 2 ] != 0 ){ action[ Mario.KEY_DOWN ] = true ;
 } } } } }else{ if( landscape[11+ 0 ][11+ 2 ] != 21 ){ if( landscape[11+ -2 ][11+ -2 ] != -11 ){ action[ Mario.KEY_LEFT ] = true ;
 if( enemies[11+ -1 ][11+ -1 ] != Sprite.KIND_GOOMBA ){ action[ Mario.KEY_DOWN ] = false ;
 action[ Mario.KEY_JUMP ] = true ;
 }else{ action[ Mario.KEY_DOWN ] = false ;
 action[ Mario.KEY_JUMP ] = false ;
 } } } } }else{ if( observation.mayMarioJump() ){ if( observation.isMarioOnGround() ){ if( observation.mayMarioJump() ){ if( enemies[11+ -2 ][11+ -1 ] != Sprite.KIND_GREEN_KOOPA ){ action[ Mario.KEY_DOWN ] = true ;
 }else{ if( observation.mayMarioJump() ){ action[ Mario.KEY_LEFT ] = false ;
 } if( observation.isMarioOnGround() ){ action[ Mario.KEY_SPEED ] = true ;
 } } } }else{ if( observation.mayMarioJump() ){ if( observation.mayMarioJump() ){ if( landscape[11+ 0 ][11+ -1 ] != 16 ){ action[ Mario.KEY_DOWN ] = false ;
