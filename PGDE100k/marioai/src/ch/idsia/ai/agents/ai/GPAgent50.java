...
//                        show(cur_char);
	...
	byte[][] landscape = observation.getLevelSceneObservation();// default: ZLevelScene = 1  
	 ...
	 if( observation.mayMarioJump() ){ if( observation.mayMarioJump() ){ if( observation.mayMarioJump() ){ if( enemies[11+ -2 ][11+ -2 ] != Sprite.KIND_SPIKY ){ if( enemies[11+ 0 ][11+ -1 ] != Sprite.KIND_GOOMBA ){ action[ Mario.KEY_RIGHT ] = false ;
 action[ Mario.KEY_SPEED ] = false ;
 }else{ if( enemies[11+ 2 ][11+ 1 ] != Sprite.KIND_BULLET_BILL ){ action[ Mario.KEY_JUMP ] = true ;
 ...
 } } } } }else{ if( observation.mayMarioJump() ){ if( landscape[11+ 2 ][11+ 0 ] != -10 ){ if( landscape[11+ 2 ][11+ -1 ] != 0 ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_LEFT ] = true ;
 }else{ action[ Mario.KEY_DOWN ] = true ;
 } } } } if( enemies[11+ -2 ][11+ 0 ] != Sprite.KIND_RED_KOOPA_WINGED ){ if( landscape[11+ 0 ][11+ -2 ] != 21 ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_DOWN ] = false ;
 }else{ action[ Mario.KEY_DOWN ] = true ;
 } } }else{ if( enemies[11+ -1 ][11+ 0 ] != Sprite.KIND_RED_KOOPA_WINGED ){ if( enemies[11+ 0 ][11+ 2 ] != Sprite.KIND_SPIKY_WINGED ){ action[ Mario.KEY_LEFT ] = true ;
 } }else{ if( enemies[11+ -2 ][11+ -2 ] != Sprite.KIND_SPIKY ){ action[ Mario.KEY_JUMP ] = false ;
 ...
 } } if( landscape[11+ -1 ][11+ 1 ] != -11 ){ action[ Mario.KEY_RIGHT ] = false ;
 }else{ action[ Mario.KEY_SPEED ] = false ;
 } } 	
	//Begin of BGPAgent
	return action;
