...
//                        show(cur_char);
 ...
 } }else{ if( observation.mayMarioJump() ){ if( enemies[11+ -2 ][11+ 1 ] != Sprite.KIND_GOOMBA ){ if( enemies[11+ 1 ][11+ -2 ] != Sprite.KIND_SPIKY ){ if( enemies[11+ 1 ][11+ -1 ] != Sprite.KIND_RED_KOOPA_WINGED ){ action[ Mario.KEY_RIGHT ] = false ;
