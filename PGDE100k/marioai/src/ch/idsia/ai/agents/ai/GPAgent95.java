...
//                        show(cur_char);
 ...
 }else{ if( enemies[11+ -1 ][11+ -1 ] != Sprite.KIND_RED_KOOPA_WINGED ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_RIGHT ] = false ;
 ...
 } }else{ if( landscape[11+ 1 ][11+ -2 ] != -10 ){ action[ Mario.KEY_LEFT ] = false ;
 action[ Mario.KEY_JUMP ] = true ;
 } } } } } action[ Mario.KEY_JUMP ] = false ;
 if( observation.isMarioOnGround() ){ if( enemies[11+ -1 ][11+ 1 ] != Sprite.KIND_SPIKY_WINGED ){ if( enemies[11+ 0 ][11+ 2 ] != Sprite.KIND_GOOMBA ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_RIGHT ] = false ;
 action[ Mario.KEY_JUMP ] = true ;
 }else{ action[ Mario.KEY_LEFT ] = true ;
 } } } }else{ if( observation.isMarioOnGround() ){ if( landscape[11+ 0 ][11+ 1 ] != 0 ){ action[ Mario.KEY_DOWN ] = false ;
 } }else{ if( observation.mayMarioJump() ){ action[ Mario.KEY_LEFT ] = false ;
 action[ Mario.KEY_RIGHT ] = false ;
 action[ Mario.KEY_JUMP ] = false ;
 action[ Mario.KEY_RIGHT ] = true ;
