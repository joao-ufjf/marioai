...
//                        show(cur_char);
	...
	byte[][] landscape = observation.getLevelSceneObservation();// default: ZLevelScene = 1  
	 ...
	 if( enemies[11+ 2 ][11+ 0 ] != Sprite.KIND_GOOMBA ){ if( observation.mayMarioJump() ){ if( observation.mayMarioJump() ){ if( landscape[11+ -1 ][11+ 0 ] != 16 ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_JUMP ] = false ;
 ...
 } } } }else{ if( landscape[11+ -2 ][11+ -1 ] != 20 ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_LEFT ] = true ;
 }else{ if( observation.mayMarioJump() ){ if( enemies[11+ 2 ][11+ 1 ] != Sprite.KIND_GREEN_KOOPA ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_RIGHT ] = true ;
 } } } } } } 	
	//Begin of BGPAgent
	return action;
    }
