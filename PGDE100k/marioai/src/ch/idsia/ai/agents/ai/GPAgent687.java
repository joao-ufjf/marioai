 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent687 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 if( observation.mayMarioJump() ){ if( landscape[11+ -1 ][11+ -1 ] != 1 ){ action[ Mario.KEY_DOWN ] = false ;
 ...
 } } } if( observation.isMarioOnGround() ){ if( landscape[11+ 1 ][11+ 1 ] != 1 ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_DOWN ] = true ;
