...
//                        show(cur_char);
	...
	byte[][] landscape = observation.getLevelSceneObservation();// default: ZLevelScene = 1  
	 ...
	 if( observation.mayMarioJump() ){ if( observation.isMarioOnGround() ){ if( enemies[11+ 1 ][11+ -1 ] != Sprite.KIND_GREEN_KOOPA_WINGED ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_LEFT ] = false ;
 }else{ action[ Mario.KEY_JUMP ] = false ;
 } }else{ if( landscape[11+ -1 ][11+ -1 ] != 0 ){ action[ Mario.KEY_SPEED ] = false ;
 } } }else{ if( enemies[11+ 0 ][11+ 1 ] != Sprite.KIND_GOOMBA ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_LEFT ] = true ;
 }else{ action[ Mario.KEY_RIGHT ] = false ;
 } } } } if( enemies[11+ -1 ][11+ 1 ] != Sprite.KIND_SPIKY ){ if( enemies[11+ -1 ][11+ 0 ] != Sprite.KIND_SPIKY ){ if( landscape[11+ 1 ][11+ 1 ] != 16 ){ action[ Mario.KEY_RIGHT ] = true ;
 }else{ action[ Mario.KEY_LEFT ] = false ;
 } } action[ Mario.KEY_RIGHT ] = false ;
 action[ Mario.KEY_DOWN ] = false ;
 action[ Mario.KEY_RIGHT ] = false ;
 action[ Mario.KEY_RIGHT ] = true ;
 } if( enemies[11+ -1 ][11+ -1 ] != Sprite.KIND_BULLET_BILL ){ if( landscape[11+ 1 ][11+ 1 ] != 0 ){ if( observation.isMarioOnGround() ){ if( enemies[11+ 1 ][11+ -1 ] != Sprite.KIND_RED_KOOPA_WINGED ){ action[ Mario.KEY_JUMP ] = false ;
 } if( landscape[11+ -1 ][11+ -1 ] != -10 ){ action[ Mario.KEY_RIGHT ] = true ;
 }else{ action[ Mario.KEY_LEFT ] = false ;
 } } }else{ if( enemies[11+ 0 ][11+ -1 ] != Sprite.KIND_SPIKY_WINGED ){ if( observation.mayMarioJump() ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_DOWN ] = false ;
 }else{ action[ Mario.KEY_DOWN ] = false ;
 } } } } }else{ if( observation.isMarioOnGround() ){ if( enemies[11+ 0 ][11+ 0 ] != Sprite.KIND_RED_KOOPA_WINGED ){ if( enemies[11+ 0 ][11+ -1 ] != Sprite.KIND_SPIKY ){ action[ Mario.KEY_LEFT ] = true ;
 action[ Mario.KEY_JUMP ] = false ;
 }else{ if( observation.isMarioOnGround() ){ action[ Mario.KEY_RIGHT ] = false ;
 }else{ action[ Mario.KEY_RIGHT ] = true ;
 } } } } } if( landscape[11+ -1 ][11+ 0 ] != -11 ){ if( landscape[11+ 1 ][11+ -1 ] != -11 ){ if( landscape[11+ -1 ][11+ -1 ] != 21 ){ if( enemies[11+ 1 ][11+ 0 ] != Sprite.KIND_RED_KOOPA ){ action[ Mario.KEY_LEFT ] = true ;
 }else{ action[ Mario.KEY_JUMP ] = false ;
 } action[ Mario.KEY_RIGHT ] = false ;
 action[ Mario.KEY_SPEED ] = true ;
 ...
 } }else{ if( observation.mayMarioJump() ){ if( landscape[11+ 0 ][11+ 0 ] != 21 ){ if( enemies[11+ -1 ][11+ -1 ] != Sprite.KIND_RED_KOOPA_WINGED ){ action[ Mario.KEY_RIGHT ] = false ;
