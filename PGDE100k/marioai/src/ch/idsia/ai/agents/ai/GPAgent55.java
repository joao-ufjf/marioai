...
//                        show(cur_char);
 ...
 } } } if( enemies[11+ -1 ][11+ 2 ] != Sprite.KIND_GOOMBA ){ action[ Mario.KEY_LEFT ] = false ;
 }else{ if( observation.mayMarioJump() ){ if( observation.mayMarioJump() ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_RIGHT ] = false ;
 } } }else{ action[ Mario.KEY_RIGHT ] = true ;
 } } if( enemies[11+ 0 ][11+ 0 ] != Sprite.KIND_GREEN_KOOPA ){ if( enemies[11+ 0 ][11+ -1 ] != Sprite.KIND_SPIKY_WINGED ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_SPEED ] = false ;
 } } }else{ if( landscape[11+ -2 ][11+ -1 ] != 20 ){ if( landscape[11+ 1 ][11+ -2 ] != -10 ){ if( landscape[11+ -2 ][11+ -2 ] != 16 ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_LEFT ] = true ;
