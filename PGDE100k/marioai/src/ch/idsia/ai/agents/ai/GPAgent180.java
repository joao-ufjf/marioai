...
//                        show(cur_char);
	...
	byte[][] landscape = observation.getLevelSceneObservation();// default: ZLevelScene = 1  
	 ...
	 if( observation.isMarioOnGround() ){ if( enemies[11+ -2 ][11+ -2 ] != Sprite.KIND_GREEN_KOOPA ){ if( enemies[11+ 2 ][11+ -2 ] != Sprite.KIND_GREEN_KOOPA ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_SPEED ] = true ;
 ...
 } }else{ if( enemies[11+ -1 ][11+ 1 ] != Sprite.KIND_SPIKY ){ action[ Mario.KEY_RIGHT ] = true ;
 } } } } } }else{ if( landscape[11+ -1 ][11+ -2 ] != -10 ){ if( observation.isMarioOnGround() ){ if( landscape[11+ -1 ][11+ -1 ] != 20 ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_DOWN ] = true ;
 }else{ action[ Mario.KEY_SPEED ] = false ;
