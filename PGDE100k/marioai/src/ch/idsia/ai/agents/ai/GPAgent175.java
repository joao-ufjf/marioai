...
//                        show(cur_char);
	...
	byte[][] landscape = observation.getLevelSceneObservation();// default: ZLevelScene = 1  
	 ...
	 if( observation.isMarioOnGround() ){ if( enemies[11+ -2 ][11+ 2 ] != Sprite.KIND_SPIKY ){ if( enemies[11+ -1 ][11+ 1 ] != Sprite.KIND_GREEN_KOOPA ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_SPEED ] = true ;
 } }else{ if( landscape[11+ -1 ][11+ 1 ] != -10 ){ action[ Mario.KEY_LEFT ] = false ;
 action[ Mario.KEY_SPEED ] = true ;
 action[ Mario.KEY_LEFT ] = true ;
 }else{ action[ Mario.KEY_RIGHT ] = false ;
 } } } }else{ if( landscape[11+ 0 ][11+ -1 ] != 0 ){ action[ Mario.KEY_DOWN ] = true ;
 }else{ action[ Mario.KEY_SPEED ] = true ;
 if( landscape[11+ 1 ][11+ -1 ] != 20 ){ if( landscape[11+ 1 ][11+ 2 ] != -11 ){ action[ Mario.KEY_SPEED ] = true ;
