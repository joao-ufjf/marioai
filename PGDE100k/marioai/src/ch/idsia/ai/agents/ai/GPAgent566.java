 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent566 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 if( enemies[11+ 1 ][11+ 0 ] != 1 ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_SPEED ] = false ;
 action[ Mario.KEY_SPEED ] = true ;
 ...
 } } if( observation.mayMarioJump() ){ if( landscape[11+ 0 ][11+ 0 ] != 1 ){ action[ Mario.KEY_DOWN ] = false ;
 }else{ action[ Mario.KEY_JUMP ] = false ;
 } }else{ action[ Mario.KEY_DOWN ] = false ;
 action[ Mario.KEY_JUMP ] = false ;
