...
//                        show(cur_char);
	...
	byte[][] landscape = observation.getLevelSceneObservation();// default: ZLevelScene = 1  
	 ...
	 if( observation.isMarioOnGround() ){ if( observation.mayMarioJump() ){ if( observation.isMarioOnGround() ){ if( landscape[11+ 0 ][11+ 2 ] != -11 ){ if( enemies[11+ 2 ][11+ 2 ] != Sprite.KIND_RED_KOOPA ){ action[ Mario.KEY_LEFT ] = true ;
