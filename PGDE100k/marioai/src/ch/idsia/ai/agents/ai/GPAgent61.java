...
//                        show(cur_char);
 ...
 } }else{ if( observation.mayMarioJump() ){ if( enemies[11+ 1 ][11+ 1 ] != Sprite.KIND_GREEN_KOOPA ){ if( enemies[11+ 1 ][11+ -2 ] != Sprite.KIND_SPIKY ){ if( enemies[11+ 0 ][11+ 2 ] != Sprite.KIND_GREEN_KOOPA ){ action[ Mario.KEY_LEFT ] = false ;
