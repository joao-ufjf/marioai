 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent13 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 } } if( landscape[11+ 0 ][11+ -1 ] != -11 ){ if( landscape[11+ 1 ][11+ 0 ] != 0 ){ action[ Mario.KEY_SPEED ] = true ;
 }else{ action[ Mario.KEY_SPEED ] = false ;
 } } if( landscape[11+ -1 ][11+ 1 ] != 21 ){ action[ Mario.KEY_SPEED ] = false ;
 action[ Mario.KEY_JUMP ] = false ;
 }else{ if( landscape[11+ 1 ][11+ -1 ] != 16 ){ action[ Mario.KEY_DOWN ] = true ;
