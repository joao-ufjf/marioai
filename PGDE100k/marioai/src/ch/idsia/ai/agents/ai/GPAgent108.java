...
//                        show(cur_char);
 ...
 if( observation.isMarioOnGround() ){ if( landscape[11+ 2 ][11+ 1 ] != 20 ){ if( observation.isMarioOnGround() ){ if( enemies[11+ 1 ][11+ 0 ] != Sprite.KIND_GOOMBA ){ action[ Mario.KEY_JUMP ] = true ;
 }else{ action[ Mario.KEY_LEFT ] = true ;
 } action[ Mario.KEY_JUMP ] = false ;
 } }else{ if( landscape[11+ 2 ][11+ -1 ] != -11 ){ action[ Mario.KEY_SPEED ] = false ;
 } } }else{ action[ Mario.KEY_JUMP ] = true ;
 } if( landscape[11+ -2 ][11+ 2 ] != 16 ){ if( observation.isMarioOnGround() ){ if( enemies[11+ 0 ][11+ -2 ] != Sprite.KIND_SPIKY_WINGED ){ if( enemies[11+ -2 ][11+ 2 ] != Sprite.KIND_RED_KOOPA_WINGED ){ action[ Mario.KEY_LEFT ] = true ;
 } }else{ if( landscape[11+ -1 ][11+ 1 ] != -10 ){ if( landscape[11+ 1 ][11+ 0 ] != 16 ){ action[ Mario.KEY_RIGHT ] = false ;
