...
//                        show(cur_char);
	...
	byte[][] landscape = observation.getLevelSceneObservation();// default: ZLevelScene = 1  
	 ...
	 if( observation.mayMarioJump() ){ if( observation.isMarioOnGround() ){ if( observation.mayMarioJump() ){ if( landscape[11+ -1 ][11+ 1 ] != 16 ){ if( landscape[11+ -1 ][11+ 1 ] != -10 ){ action[ Mario.KEY_LEFT ] = true ;
 ...
 } }else{ if( landscape[11+ -2 ][11+ 2 ] != 16 ){ action[ Mario.KEY_DOWN ] = false ;
 } action[ Mario.KEY_RIGHT ] = true ;
 action[ Mario.KEY_RIGHT ] = true ;
