...
//                        show(cur_char);
 ...
 }else{ if( observation.isMarioOnGround() ){ if( observation.isMarioOnGround() ){ if( landscape[11+ -1 ][11+ -1 ] != 20 ){ action[ Mario.KEY_JUMP ] = true ;
 ...
 } } if( observation.mayMarioJump() ){ if( observation.mayMarioJump() ){ if( landscape[11+ 1 ][11+ 0 ] != 16 ){ action[ Mario.KEY_DOWN ] = false ;
 }else{ action[ Mario.KEY_SPEED ] = true ;
 } } if( enemies[11+ 1 ][11+ 0 ] != Sprite.KIND_BULLET_BILL ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_SPEED ] = false ;
 }else{ action[ Mario.KEY_JUMP ] = true ;
 } }else{ if( enemies[11+ 0 ][11+ 1 ] != Sprite.KIND_BULLET_BILL ){ action[ Mario.KEY_LEFT ] = true ;
 } } } if( observation.isMarioOnGround() ){ if( enemies[11+ -1 ][11+ 0 ] != Sprite.KIND_SPIKY_WINGED ){ action[ Mario.KEY_LEFT ] = true ;
 action[ Mario.KEY_RIGHT ] = true ;
 } if( landscape[11+ -1 ][11+ -1 ] != -10 ){ action[ Mario.KEY_DOWN ] = false ;
