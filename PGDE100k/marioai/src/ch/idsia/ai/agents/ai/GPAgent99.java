...
//                        show(cur_char);
 ...
 if( observation.isMarioOnGround() ){ if( landscape[11+ -2 ][11+ 1 ] != 0 ){ if( enemies[11+ -1 ][11+ -1 ] != Sprite.KIND_GREEN_KOOPA_WINGED ){ action[ Mario.KEY_DOWN ] = false ;
 } } }else{ action[ Mario.KEY_DOWN ] = true ;
 if( landscape[11+ -2 ][11+ -2 ] != 20 ){ action[ Mario.KEY_JUMP ] = false ;
