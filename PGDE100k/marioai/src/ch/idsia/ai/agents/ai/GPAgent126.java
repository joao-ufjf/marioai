...
//                        show(cur_char);
	...
	byte[][] landscape = observation.getLevelSceneObservation();// default: ZLevelScene = 1  
	 ...
	 if( observation.isMarioOnGround() ){ if( observation.mayMarioJump() ){ if( observation.isMarioOnGround() ){ if( landscape[11+ -2 ][11+ 1 ] != 0 ){ action[ Mario.KEY_SPEED ] = false ;
 ...
 } } } } }else{ if( observation.mayMarioJump() ){ if( landscape[11+ -2 ][11+ 1 ] != 20 ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_DOWN ] = false ;
