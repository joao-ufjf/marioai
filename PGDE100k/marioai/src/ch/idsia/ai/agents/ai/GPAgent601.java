 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent601 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 }else{ if( enemies[11+ 0 ][11+ -1 ] != 1 ){ if( landscape[11+ -1 ][11+ -1 ] != 1 ){ action[ Mario.KEY_LEFT ] = false ;
 ...
 } } } }else{ if( enemies[11+ -1 ][11+ -1 ] != 1 ){ if( observation.isMarioOnGround() ){ if( landscape[11+ -1 ][11+ 1 ] != 1 ){ action[ Mario.KEY_LEFT ] = true ;
