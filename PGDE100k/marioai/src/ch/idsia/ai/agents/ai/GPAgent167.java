...
//                        show(cur_char);
 ...
 action[ Mario.KEY_SPEED ] = true ;
 } } }else{ if( landscape[11+ 0 ][11+ -2 ] != 21 ){ if( landscape[11+ -1 ][11+ -2 ] != -11 ){ action[ Mario.KEY_RIGHT ] = true ;
 ...
 } } }else{ if( enemies[11+ 2 ][11+ -2 ] != Sprite.KIND_GREEN_KOOPA_WINGED ){ if( landscape[11+ 0 ][11+ 0 ] != 20 ){ action[ Mario.KEY_LEFT ] = true ;
 } }else{ action[ Mario.KEY_JUMP ] = true ;
 } } } 	
	//Begin of BGPAgent
	return action;
