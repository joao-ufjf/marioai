...
//                        show(cur_char);
 ...
 if( landscape[11+ -2 ][11+ -1 ] != -10 ){ if( landscape[11+ 0 ][11+ 1 ] != 0 ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_DOWN ] = true ;
 } } }else{ action[ Mario.KEY_SPEED ] = false ;
 if( landscape[11+ -2 ][11+ -2 ] != 20 ){ action[ Mario.KEY_LEFT ] = false ;
 } } action[ Mario.KEY_LEFT ] = true ;
 } }else{ if( observation.isMarioOnGround() ){ if( observation.mayMarioJump() ){ if( landscape[11+ -1 ][11+ -2 ] != -10 ){ if( observation.isMarioOnGround() ){ if( landscape[11+ -2 ][11+ -1 ] != 20 ){ action[ Mario.KEY_LEFT ] = false ;
