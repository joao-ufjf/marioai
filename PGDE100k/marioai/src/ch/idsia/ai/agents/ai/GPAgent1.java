...
//                        show(cur_char);
 ...
 if( landscape[11+ 1 ][11+ 0 ] != 0 ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_LEFT ] = false ;
 }else{ action[ Mario.KEY_LEFT ] = false ;
 } if( observation.mayMarioJump() ){ action[ Mario.KEY_RIGHT ] = false ;
 action[ Mario.KEY_RIGHT ] = true ;
 }else{ if( enemies[11+ -1 ][11+ 0 ] != Sprite.KIND_RED_KOOPA ){ action[ Mario.KEY_RIGHT ] = false ;
 } } } if( enemies[11+ 1 ][11+ 0 ] != Sprite.KIND_GREEN_KOOPA ){ if( landscape[11+ -1 ][11+ -1 ] != 20 ){ action[ Mario.KEY_DOWN ] = false ;
 }else{ action[ Mario.KEY_LEFT ] = false ;
 } }else{ if( landscape[11+ 1 ][11+ -1 ] != -10 ){ action[ Mario.KEY_DOWN ] = true ;
 action[ Mario.KEY_DOWN ] = true ;
 action[ Mario.KEY_DOWN ] = false ;
 } } action[ Mario.KEY_DOWN ] = false ;
 if( observation.isMarioOnGround() ){ if( landscape[11+ 0 ][11+ 1 ] != 16 ){ if( landscape[11+ -1 ][11+ -1 ] != 21 ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_LEFT ] = false ;
 ...
 } } }else{ if( landscape[11+ 0 ][11+ 1 ] != 0 ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_SPEED ] = false ;
