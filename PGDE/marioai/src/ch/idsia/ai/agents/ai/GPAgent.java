...
//                        show(cur_char);
  ...
  if( observation.mayMarioJump() ){ if( landscape[11+ 1 ][11+ 1 ] != 1 ){ if( enemies[11+ 1 ][11+ 1 ] != 1 ){ action[ Mario.KEY_JUMP ] = true ;
 ...
 } } if( landscape[11+ -1 ][11+ 0 ] != 1 ){ if( enemies[11+ 0 ][11+ 1 ] != 1 ){ action[ Mario.KEY_SPEED ] = false ;
 }else{ action[ Mario.KEY_LEFT ] = false ;
 ...
 action[ Mario.KEY_SPEED ] = false ;
 action[ Mario.KEY_JUMP ] = true ;
 if( observation.isMarioOnGround() ){ if( enemies[11+ -1 ][11+ -1 ] != 1 ){ action[ Mario.KEY_DOWN ] = true ;
 }else{ action[ Mario.KEY_RIGHT ] = true ;
 } }else{ action[ Mario.KEY_RIGHT ] = false ;
 action[ Mario.KEY_SPEED ] = false ;
 } if( enemies[11+ 1 ][11+ 1 ] != 1 ){ if( enemies[11+ 0 ][11+ -1 ] != 1 ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_RIGHT ] = true ;
 }else{ action[ Mario.KEY_JUMP ] = false ;
