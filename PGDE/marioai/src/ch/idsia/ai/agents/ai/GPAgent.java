...
//                        show(cur_char);
  ...
  if( landscape[11+ 1 ][11+ -1 ] != 1 ){ if( observation.mayMarioJump() ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_SPEED ] = true ;
 action[ Mario.KEY_JUMP ] = true ;
 }else{ action[ Mario.KEY_SPEED ] = true ;
 } }else{ if( enemies[11+ 0 ][11+ 1 ] != 1 ){ if( enemies[11+ -1 ][11+ 0 ] != 1 ){ action[ Mario.KEY_LEFT ] = false ;
 ...
 } } } if( observation.mayMarioJump() ){ if( landscape[11+ 1 ][11+ 0 ] != 1 ){ action[ Mario.KEY_SPEED ] = true ;
 ...
 } }else{ if( observation.mayMarioJump() ){ if( enemies[11+ 0 ][11+ -1 ] != 1 ){ action[ Mario.KEY_LEFT ] = true ;
 ...
 }else{ if( observation.mayMarioJump() ){ if( enemies[11+ 1 ][11+ 1 ] != 1 ){ if( landscape[11+ -1 ][11+ 1 ] != 1 ){ action[ Mario.KEY_SPEED ] = false ;
 ...
 } } } if( landscape[11+ 0 ][11+ -1 ] != 1 ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_RIGHT ] = true ;
 ...
 action[ Mario.KEY_DOWN ] = true ;
 } } if( observation.mayMarioJump() ){ if( landscape[11+ -1 ][11+ 0 ] != 1 ){ action[ Mario.KEY_LEFT ] = false ;
 action[ Mario.KEY_JUMP ] = false ;
 action[ Mario.KEY_RIGHT ] = false ;
 }else{ action[ Mario.KEY_JUMP ] = true ;
 } }else{ if( enemies[11+ 0 ][11+ -1 ] != 1 ){ if( enemies[11+ 0 ][11+ -1 ] != 1 ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_JUMP ] = false ;
 ...
 if( enemies[11+ 1 ][11+ -1 ] != 1 ){ if( landscape[11+ 0 ][11+ 0 ] != 1 ){ action[ Mario.KEY_JUMP ] = false ;
 }else{ action[ Mario.KEY_RIGHT ] = true ;
 } }else{ action[ Mario.KEY_JUMP ] = true ;
 } action[ Mario.KEY_DOWN ] = true ;
 action[ Mario.KEY_JUMP ] = true ;
