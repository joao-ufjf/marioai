...
RK4AGParser::RK4AGParser() {
    //ctor
}
string RK4AGParser::nameParser() {
    return "RK4AGParser";
}

void RK4AGParser::setDataSet(double ** x,int tam) {
    tamDataset = tam;
    dataset = x;
}


double RK4AGParser::Evaluate(Subject* s) {
...
double ** RK4AGParser::RKEvaluateVariable(Subject* s, double** matrix, int vars, double h, int iterations) {
...
double** RK4AGParser::RKEvaluate(Subject* s, double* initial, int vars, double h, int iterations) {
//    cout << "h = " << h << endl;
...
double RK4AGParser::AuxEvaluate(Subject* s, int model, double* dat, double* increments) {
//    for(int i = 0; i < 3; i++)
//        cout << increments[i] << " e ";
//    cout << endl;
