 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent10 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 } } }else{ if( landscape[11+ -1 ][11+ -1 ] != 1 ){ if( landscape[11+ -1 ][11+ 1 ] != 1 ){ if( enemies[11+ 0 ][11+ -1 ] != 1 ){ action[ Mario.KEY_JUMP ] = true ;
 action[ Mario.KEY_SPEED ] = true ;
