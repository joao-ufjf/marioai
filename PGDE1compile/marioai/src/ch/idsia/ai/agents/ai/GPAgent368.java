 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent368 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 }else{ if( enemies[11+ -1 ][11+ -1 ] != 1 ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_RIGHT ] = false ;
 ...
 } } }else{ if( observation.mayMarioJump() ){ if( enemies[11+ 1 ][11+ 0 ] != 1 ){ action[ Mario.KEY_SPEED ] = true ;
 }else{ action[ Mario.KEY_RIGHT ] = false ;
 } }else{ action[ Mario.KEY_DOWN ] = true ;
 action[ Mario.KEY_DOWN ] = false ;
 } } } }else{ action[ Mario.KEY_JUMP ] = false ;
 } } action[ Mario.KEY_JUMP ] = true ;
 if( observation.isMarioOnGround() ){ if( observation.mayMarioJump() ){ if( enemies[11+ 0 ][11+ 1 ] != 1 ){ if( landscape[11+ -1 ][11+ 0 ] != 1 ){ action[ Mario.KEY_RIGHT ] = true ;
