 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent511 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
	...
	byte[][] landscape = observation.getLevelSceneObservation();// default: ZLevelScene = 1  
	 ...
	 if( observation.isMarioOnGround() ){ if( observation.isMarioOnGround() ){ if( enemies[11+ 1 ][11+ 1 ] != 1 ){ action[ Mario.KEY_JUMP ] = false ;
 ...
 } } }else{ if( observation.isMarioOnGround() ){ if( landscape[11+ 1 ][11+ -1 ] != 1 ){ if( landscape[11+ -1 ][11+ -1 ] != 1 ){ action[ Mario.KEY_LEFT ] = true ;
 action[ Mario.KEY_JUMP ] = true ;
 }else{ action[ Mario.KEY_SPEED ] = false ;
 action[ Mario.KEY_RIGHT ] = false ;
 } }else{ if( observation.isMarioOnGround() ){ action[ Mario.KEY_RIGHT ] = true ;
 }else{ action[ Mario.KEY_JUMP ] = false ;
 } if( landscape[11+ -1 ][11+ 0 ] != 1 ){ action[ Mario.KEY_JUMP ] = true ;
 }else{ action[ Mario.KEY_SPEED ] = false ;
 } } }else{ if( observation.isMarioOnGround() ){ if( landscape[11+ 0 ][11+ 0 ] != 1 ){ action[ Mario.KEY_SPEED ] = true ;
 ...
 } }else{ if( observation.isMarioOnGround() ){ if( landscape[11+ 1 ][11+ -1 ] != 1 ){ if( landscape[11+ 1 ][11+ 1 ] != 1 ){ action[ Mario.KEY_DOWN ] = true ;
 }else{ action[ Mario.KEY_DOWN ] = false ;
 } }else{ action[ Mario.KEY_SPEED ] = true ;
 ...
 action[ Mario.KEY_LEFT ] = true ;
 } if( landscape[11+ 0 ][11+ 0 ] != 1 ){ action[ Mario.KEY_SPEED ] = true ;
 action[ Mario.KEY_DOWN ] = true ;
 }else{ if( observation.isMarioOnGround() ){ action[ Mario.KEY_RIGHT ] = true ;
 }else{ action[ Mario.KEY_JUMP ] = false ;
 } } if( landscape[11+ 1 ][11+ -1 ] != 1 ){ if( landscape[11+ 1 ][11+ 1 ] != 1 ){ if( landscape[11+ -1 ][11+ 0 ] != 1 ){ action[ Mario.KEY_RIGHT ] = false ;
 }else{ action[ Mario.KEY_DOWN ] = false ;
 ...
 action[ Mario.KEY_LEFT ] = false ;
 } if( landscape[11+ -1 ][11+ -1 ] != 1 ){ if( enemies[11+ -1 ][11+ 0 ] != 1 ){ action[ Mario.KEY_DOWN ] = true ;
 }else{ action[ Mario.KEY_DOWN ] = false ;
 } if( observation.isMarioOnGround() ){ action[ Mario.KEY_JUMP ] = true ;
 }else{ action[ Mario.KEY_DOWN ] = false ;
 ...
 action[ Mario.KEY_SPEED ] = false ;
 } } }else{ if( observation.mayMarioJump() ){ if( landscape[11+ -1 ][11+ -1 ] != 1 ){ action[ Mario.KEY_DOWN ] = false ;
 }else{ action[ Mario.KEY_JUMP ] = false ;
 ...
 action[ Mario.KEY_LEFT ] = true ;
 action[ Mario.KEY_LEFT ] = true ;
 } if( observation.mayMarioJump() ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_JUMP ] = false ;
 action[ Mario.KEY_LEFT ] = false ;
 }else{ action[ Mario.KEY_SPEED ] = false ;
 action[ Mario.KEY_LEFT ] = false ;
 } if( observation.isMarioOnGround() ){ action[ Mario.KEY_JUMP ] = true ;
 ...
 } }else{ if( enemies[11+ 0 ][11+ 1 ] != 1 ){ action[ Mario.KEY_SPEED ] = false ;
 }else{ action[ Mario.KEY_LEFT ] = true ;
 } } } } } 	
	//Begin of BGPAgent
	return action;
