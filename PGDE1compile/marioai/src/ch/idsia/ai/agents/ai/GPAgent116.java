 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent116 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 } } } } } if( observation.mayMarioJump() ){ if( enemies[11+ -2 ][11+ 1 ] != Sprite.KIND_GREEN_KOOPA_WINGED ){ if( landscape[11+ 3 ][11+ -3 ] != 16 ){ action[ Mario.KEY_LEFT ] = true ;
