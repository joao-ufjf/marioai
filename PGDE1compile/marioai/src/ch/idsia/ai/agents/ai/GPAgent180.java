...
//                        show(cur_char);
 ...
 } } } } if( landscape[11+ -3 ][11+ 3 ] != -11 ){ if( landscape[11+ 1 ][11+ 0 ] != -10 ){ if( enemies[11+ -3 ][11+ 3 ] != Sprite.KIND_RED_KOOPA ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_DOWN ] = true ;
