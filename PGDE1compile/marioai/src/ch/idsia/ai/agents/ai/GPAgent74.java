 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent74 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
	...
	byte[][] landscape = observation.getLevelSceneObservation();// default: ZLevelScene = 1  
	 ...
	 if( observation.isMarioOnGround() ){ if( observation.isMarioOnGround() ){ if( observation.mayMarioJump() ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_JUMP ] = false ;
 action[ Mario.KEY_DOWN ] = true ;
 } } } if( landscape[11+ -1 ][11+ -3 ] != -11 ){ if( landscape[11+ 0 ][11+ -3 ] != 16 ){ action[ Mario.KEY_RIGHT ] = true ;
 if( landscape[11+ -2 ][11+ -3 ] != 0 ){ action[ Mario.KEY_LEFT ] = true ;
 } }else{ if( observation.mayMarioJump() ){ if( landscape[11+ -1 ][11+ 3 ] != 0 ){ action[ Mario.KEY_RIGHT ] = false ;
 } }else{ action[ Mario.KEY_RIGHT ] = true ;
 } } }else{ if( observation.mayMarioJump() ){ if( landscape[11+ 0 ][11+ 3 ] != 16 ){ action[ Mario.KEY_JUMP ] = false ;
 } } } if( landscape[11+ 2 ][11+ -2 ] != 21 ){ action[ Mario.KEY_DOWN ] = true ;
 ...
 } } } }else{ if( landscape[11+ -1 ][11+ 1 ] != 21 ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_SPEED ] = true ;
