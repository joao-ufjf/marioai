 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent55 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 } if( observation.isMarioOnGround() ){ if( enemies[11+ 0 ][11+ -2 ] != Sprite.KIND_GOOMBA ){ if( enemies[11+ -2 ][11+ 1 ] != Sprite.KIND_GOOMBA ){ if( observation.mayMarioJump() ){ if( landscape[11+ -3 ][11+ 0 ] != 21 ){ action[ Mario.KEY_DOWN ] = true ;
