 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent6 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 } } } if( observation.isMarioOnGround() ){ if( observation.mayMarioJump() ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_SPEED ] = false ;
 }else{ action[ Mario.KEY_SPEED ] = false ;
 ...
 } } }else{ if( landscape[11+ -1 ][11+ -1 ] != 1 ){ if( landscape[11+ -1 ][11+ 1 ] != 1 ){ if( enemies[11+ 0 ][11+ -1 ] != 1 ){ action[ Mario.KEY_SPEED ] = true ;
 action[ Mario.KEY_SPEED ] = true ;
