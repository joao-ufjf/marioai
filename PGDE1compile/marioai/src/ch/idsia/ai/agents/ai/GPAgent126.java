 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent126 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 } }else{ if( landscape[11+ 0 ][11+ -1 ] != -11 ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_JUMP ] = false ;
 ...
 } } } if( observation.mayMarioJump() ){ if( landscape[11+ -2 ][11+ -1 ] != 21 ){ if( enemies[11+ 3 ][11+ -3 ] != Sprite.KIND_BULLET_BILL ){ action[ Mario.KEY_LEFT ] = true ;
 ...
 } } if( landscape[11+ -1 ][11+ 0 ] != 0 ){ if( observation.isMarioOnGround() ){ if( enemies[11+ 1 ][11+ 1 ] != Sprite.KIND_GREEN_KOOPA_WINGED ){ action[ Mario.KEY_DOWN ] = true ;
 }else{ action[ Mario.KEY_RIGHT ] = true ;
 } }else{ if( enemies[11+ -2 ][11+ 1 ] != Sprite.KIND_RED_KOOPA_WINGED ){ action[ Mario.KEY_JUMP ] = true ;
 action[ Mario.KEY_RIGHT ] = true ;
 ...
 } } if( enemies[11+ -3 ][11+ 3 ] != Sprite.KIND_RED_KOOPA ){ if( observation.mayMarioJump() ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_DOWN ] = false ;
 ...
 } } } } if( enemies[11+ 0 ][11+ 3 ] != Sprite.KIND_BULLET_BILL ){ if( landscape[11+ 1 ][11+ 2 ] != 16 ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_JUMP ] = true ;
 action[ Mario.KEY_SPEED ] = false ;
 if( enemies[11+ -2 ][11+ -1 ] != Sprite.KIND_SPIKY_WINGED ){ action[ Mario.KEY_SPEED ] = false ;
 }else{ action[ Mario.KEY_RIGHT ] = false ;
 } } } }else{ if( enemies[11+ 1 ][11+ 3 ] != Sprite.KIND_BULLET_BILL ){ if( observation.isMarioOnGround() ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_RIGHT ] = false ;
 }else{ action[ Mario.KEY_DOWN ] = false ;
 } } }else{ if( enemies[11+ -1 ][11+ 2 ] != Sprite.KIND_GREEN_KOOPA ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_RIGHT ] = false ;
 }else{ action[ Mario.KEY_JUMP ] = false ;
 } }else{ action[ Mario.KEY_SPEED ] = true ;
 action[ Mario.KEY_LEFT ] = false ;
 } } action[ Mario.KEY_LEFT ] = true ;
