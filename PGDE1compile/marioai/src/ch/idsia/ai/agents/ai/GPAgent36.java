 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent36 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 } } } } } if( landscape[11+ -2 ][11+ -2 ] != -11 ){ if( observation.mayMarioJump() ){ if( landscape[11+ 0 ][11+ 3 ] != -10 ){ action[ Mario.KEY_JUMP ] = true ;
