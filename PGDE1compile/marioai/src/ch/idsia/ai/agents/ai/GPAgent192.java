...
//                        show(cur_char);
 ...
 } } }else{ if( landscape[11+ -1 ][11+ 0 ] != 20 ){ if( landscape[11+ -1 ][11+ -2 ] != -11 ){ action[ Mario.KEY_SPEED ] = true ;
 ...
 action[ Mario.KEY_LEFT ] = true ;
 } if( enemies[11+ -1 ][11+ 1 ] != Sprite.KIND_GOOMBA_WINGED ){ if( observation.isMarioOnGround() ){ if( landscape[11+ 2 ][11+ 0 ] != 0 ){ action[ Mario.KEY_JUMP ] = true ;
