...
//                        show(cur_char);
 ...
 } } if( landscape[11+ -2 ][11+ -2 ] != 0 ){ if( landscape[11+ 0 ][11+ 1 ] != 21 ){ if( enemies[11+ 1 ][11+ 0 ] != Sprite.KIND_GOOMBA ){ action[ Mario.KEY_DOWN ] = false ;
 ...
 } } }else{ if( observation.isMarioOnGround() ){ if( enemies[11+ -2 ][11+ 2 ] != Sprite.KIND_GREEN_KOOPA ){ action[ Mario.KEY_LEFT ] = false ;
 }else{ action[ Mario.KEY_JUMP ] = true ;
 } if( enemies[11+ -1 ][11+ -2 ] != Sprite.KIND_SPIKY ){ action[ Mario.KEY_JUMP ] = true ;
 }else{ action[ Mario.KEY_DOWN ] = false ;
 } }else{ if( landscape[11+ 1 ][11+ 2 ] != 0 ){ action[ Mario.KEY_JUMP ] = true ;
 ...
 } }else{ if( landscape[11+ 0 ][11+ 0 ] != 21 ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_RIGHT ] = true ;
