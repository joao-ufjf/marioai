...
//                        show(cur_char);
 ...
 if( enemies[11+ -3 ][11+ 3 ] != Sprite.KIND_RED_KOOPA_WINGED ){ action[ Mario.KEY_JUMP ] = true ;
 ...
 } }else{ if( enemies[11+ -2 ][11+ 1 ] != Sprite.KIND_RED_KOOPA_WINGED ){ action[ Mario.KEY_DOWN ] = true ;
 ...
 } } if( landscape[11+ 3 ][11+ 1 ] != 21 ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_LEFT ] = true ;
 }else{ action[ Mario.KEY_DOWN ] = false ;
 } } if( observation.isMarioOnGround() ){ if( enemies[11+ 0 ][11+ 1 ] != Sprite.KIND_GOOMBA ){ if( observation.mayMarioJump() ){ if( enemies[11+ 0 ][11+ -1 ] != Sprite.KIND_GOOMBA ){ action[ Mario.KEY_LEFT ] = true ;
 action[ Mario.KEY_DOWN ] = false ;
 }else{ action[ Mario.KEY_RIGHT ] = true ;
 } } } } if( landscape[11+ -2 ][11+ -3 ] != 16 ){ if( observation.mayMarioJump() ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_DOWN ] = false ;
 } }else{ if( observation.isMarioOnGround() ){ action[ Mario.KEY_DOWN ] = false ;
 }else{ action[ Mario.KEY_DOWN ] = false ;
 } action[ Mario.KEY_DOWN ] = true ;
 action[ Mario.KEY_LEFT ] = true ;
 } } if( landscape[11+ 3 ][11+ 2 ] != 21 ){ action[ Mario.KEY_SPEED ] = true ;
 if( observation.mayMarioJump() ){ action[ Mario.KEY_SPEED ] = false ;
 } } if( enemies[11+ 1 ][11+ -1 ] != Sprite.KIND_BULLET_BILL ){ if( landscape[11+ 1 ][11+ 3 ] != -10 ){ if( observation.isMarioOnGround() ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_SPEED ] = true ;
