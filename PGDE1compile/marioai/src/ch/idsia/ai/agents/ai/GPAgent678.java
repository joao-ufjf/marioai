 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent678 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 } } } }else{ if( enemies[11+ 1 ][11+ 0 ] != 1 ){ if( landscape[11+ 1 ][11+ 0 ] != 1 ){ action[ Mario.KEY_LEFT ] = true ;
 ...
 } } } }else{ if( enemies[11+ 0 ][11+ 0 ] != 1 ){ if( observation.mayMarioJump() ){ if( enemies[11+ -1 ][11+ 0 ] != 1 ){ action[ Mario.KEY_DOWN ] = true ;
