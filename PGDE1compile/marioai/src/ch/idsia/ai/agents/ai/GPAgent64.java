 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent64 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 } if( landscape[11+ -1 ][11+ 0 ] != 1 ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_DOWN ] = false ;
 ...
 } if( enemies[11+ -1 ][11+ -1 ] != 1 ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_LEFT ] = true ;
 ...
 }else{ if( observation.mayMarioJump() ){ if( landscape[11+ 1 ][11+ -1 ] != 1 ){ action[ Mario.KEY_JUMP ] = true ;
 }else{ action[ Mario.KEY_SPEED ] = true ;
 } }else{ action[ Mario.KEY_JUMP ] = false ;
 } } action[ Mario.KEY_LEFT ] = true ;
 action[ Mario.KEY_SPEED ] = true ;
 ...
 action[ Mario.KEY_DOWN ] = false ;
 } if( observation.isMarioOnGround() ){ if( landscape[11+ 0 ][11+ 1 ] != 1 ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_JUMP ] = true ;
 }else{ action[ Mario.KEY_DOWN ] = false ;
 } action[ Mario.KEY_RIGHT ] = false ;
 action[ Mario.KEY_SPEED ] = true ;
 action[ Mario.KEY_DOWN ] = true ;
 ...
 if( enemies[11+ 0 ][11+ 0 ] != 1 ){ if( enemies[11+ 0 ][11+ -1 ] != 1 ){ action[ Mario.KEY_LEFT ] = true ;
 action[ Mario.KEY_DOWN ] = false ;
