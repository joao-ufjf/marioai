 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent53 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
	...
	byte[][] landscape = observation.getLevelSceneObservation();// default: ZLevelScene = 1  
	 ...
	 if( observation.isMarioOnGround() ){ if( landscape[11+ -2 ][11+ 0 ] != -10 ){ action[ Mario.KEY_SPEED ] = true ;
 ...
 } } } if( observation.isMarioOnGround() ){ if( enemies[11+ 0 ][11+ 3 ] != Sprite.KIND_GOOMBA ){ if( enemies[11+ -1 ][11+ 1 ] != Sprite.KIND_GOOMBA ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_RIGHT ] = false ;
 action[ Mario.KEY_SPEED ] = true ;
