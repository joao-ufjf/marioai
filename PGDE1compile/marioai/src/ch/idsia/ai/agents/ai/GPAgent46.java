 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent46 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 action[ Mario.KEY_SPEED ] = true ;
 if( landscape[11+ -2 ][11+ 3 ] != 16 ){ action[ Mario.KEY_DOWN ] = false ;
 ...
 action[ Mario.KEY_DOWN ] = true ;
 }else{ if( landscape[11+ 3 ][11+ -3 ] != 16 ){ action[ Mario.KEY_RIGHT ] = false ;
