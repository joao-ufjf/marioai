...
//                        show(cur_char);
	...
	byte[][] landscape = observation.getLevelSceneObservation();// default: ZLevelScene = 1  
	 ...
	 if( observation.mayMarioJump() ){ if( enemies[11+ -2 ][11+ 2 ] != Sprite.KIND_GREEN_KOOPA ){ if( observation.mayMarioJump() ){ if( landscape[11+ 1 ][11+ 1 ] != 16 ){ action[ Mario.KEY_RIGHT ] = true ;
 ...
 } }else{ if( landscape[11+ -2 ][11+ 1 ] != 20 ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_JUMP ] = true ;
 ...
 } } } }else{ if( observation.isMarioOnGround() ){ if( landscape[11+ 0 ][11+ 1 ] != -10 ){ action[ Mario.KEY_JUMP ] = true ;
