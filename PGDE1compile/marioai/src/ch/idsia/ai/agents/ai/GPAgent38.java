...
//                        show(cur_char);
	...
	byte[][] landscape = observation.getLevelSceneObservation();// default: ZLevelScene = 1  
	 ...
	 if( observation.isMarioOnGround() ){ if( landscape[11+ 2 ][11+ 0 ] != 20 ){ action[ Mario.KEY_SPEED ] = true ;
 } action[ Mario.KEY_JUMP ] = false ;
 }else{ if( landscape[11+ -3 ][11+ 2 ] != -10 ){ action[ Mario.KEY_SPEED ] = true ;
 ...
 action[ Mario.KEY_JUMP ] = false ;
 } } if( observation.isMarioOnGround() ){ if( observation.isMarioOnGround() ){ if( enemies[11+ -2 ][11+ 1 ] != Sprite.KIND_RED_KOOPA ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_LEFT ] = false ;
 action[ Mario.KEY_DOWN ] = true ;
 }else{ if( landscape[11+ -2 ][11+ -3 ] != -11 ){ action[ Mario.KEY_RIGHT ] = false ;
 } } } } } if( landscape[11+ -2 ][11+ -3 ] != -11 ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_LEFT ] = false ;
 ...
 action[ Mario.KEY_LEFT ] = true ;
 } } if( enemies[11+ -1 ][11+ 0 ] != Sprite.KIND_SPIKY ){ if( observation.isMarioOnGround() ){ if( observation.mayMarioJump() ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_RIGHT ] = true ;
 } } } } if( enemies[11+ 1 ][11+ 3 ] != Sprite.KIND_BULLET_BILL ){ if( landscape[11+ 1 ][11+ 2 ] != 21 ){ if( observation.isMarioOnGround() ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_LEFT ] = true ;
