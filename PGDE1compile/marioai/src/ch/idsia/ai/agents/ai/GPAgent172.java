...
//                        show(cur_char);
 ...
 } } if( observation.isMarioOnGround() ){ if( observation.isMarioOnGround() ){ if( landscape[11+ 1 ][11+ 0 ] != -11 ){ action[ Mario.KEY_SPEED ] = false ;
 ...
 } }else{ if( observation.isMarioOnGround() ){ if( landscape[11+ 0 ][11+ -2 ] != -10 ){ action[ Mario.KEY_RIGHT ] = false ;
