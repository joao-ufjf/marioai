...
//                        show(cur_char);
	...
	byte[][] landscape = observation.getLevelSceneObservation();// default: ZLevelScene = 1  
	 ...
	 if( landscape[11+ 1 ][11+ 0 ] != 1 ){ if( enemies[11+ -1 ][11+ 0 ] != 1 ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_SPEED ] = true ;
 ...
 } } if( observation.isMarioOnGround() ){ if( enemies[11+ -1 ][11+ 1 ] != 1 ){ if( landscape[11+ 0 ][11+ -1 ] != 1 ){ action[ Mario.KEY_SPEED ] = true ;
 ...
 } } if( observation.mayMarioJump() ){ if( observation.isMarioOnGround() ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_RIGHT ] = true ;
 } }else{ action[ Mario.KEY_LEFT ] = true ;
