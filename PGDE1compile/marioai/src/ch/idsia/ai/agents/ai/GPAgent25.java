 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent25 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 } } } }else{ if( observation.mayMarioJump() ){ if( enemies[11+ -1 ][11+ -2 ] != Sprite.KIND_RED_KOOPA ){ action[ Mario.KEY_RIGHT ] = false ;
