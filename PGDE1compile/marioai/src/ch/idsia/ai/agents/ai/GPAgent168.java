 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent168 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 } if( landscape[11+ -3 ][11+ -1 ] != 21 ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_LEFT ] = false ;
 } }else{ action[ Mario.KEY_SPEED ] = false ;
 } if( observation.isMarioOnGround() ){ if( observation.isMarioOnGround() ){ if( enemies[11+ -3 ][11+ 1 ] != Sprite.KIND_GREEN_KOOPA_WINGED ){ action[ Mario.KEY_LEFT ] = true ;
 ...
 } } } } if( enemies[11+ 1 ][11+ -2 ] != Sprite.KIND_BULLET_BILL ){ if( landscape[11+ 1 ][11+ 2 ] != 16 ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_JUMP ] = true ;
