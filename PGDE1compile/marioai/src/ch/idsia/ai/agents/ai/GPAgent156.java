...
//                        show(cur_char);
 ...
 } if( enemies[11+ -2 ][11+ 0 ] != Sprite.KIND_RED_KOOPA_WINGED ){ action[ Mario.KEY_DOWN ] = true ;
 ...
 } if( landscape[11+ -1 ][11+ 2 ] != 20 ){ if( enemies[11+ 2 ][11+ -1 ] != Sprite.KIND_GOOMBA ){ if( landscape[11+ -2 ][11+ 1 ] != 20 ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_JUMP ] = false ;
 } }else{ action[ Mario.KEY_SPEED ] = true ;
 } } } 	
	//Begin of BGPAgent
	return action;
