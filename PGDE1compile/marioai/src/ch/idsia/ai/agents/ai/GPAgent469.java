 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent469 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 } } } if( enemies[11+ 1 ][11+ -1 ] != 1 ){ if( landscape[11+ 1 ][11+ 0 ] != 1 ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_RIGHT ] = false ;
 }else{ action[ Mario.KEY_RIGHT ] = true ;
 } }else{ action[ Mario.KEY_RIGHT ] = true ;
