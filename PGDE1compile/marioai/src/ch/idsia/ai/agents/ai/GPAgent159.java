 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent159 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 } } if( landscape[11+ -1 ][11+ -1 ] != 0 ){ if( observation.isMarioOnGround() ){ if( landscape[11+ 3 ][11+ -3 ] != 21 ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_LEFT ] = false ;
 }else{ action[ Mario.KEY_RIGHT ] = true ;
