 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent88 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 } if( landscape[11+ 0 ][11+ 2 ] != -11 ){ action[ Mario.KEY_SPEED ] = true ;
 ...
 } if( observation.mayMarioJump() ){ if( observation.mayMarioJump() ){ if( enemies[11+ 0 ][11+ 2 ] != Sprite.KIND_SPIKY ){ action[ Mario.KEY_RIGHT ] = true ;
 } }else{ action[ Mario.KEY_SPEED ] = false ;
 } }else{ if( enemies[11+ 3 ][11+ -1 ] != Sprite.KIND_BULLET_BILL ){ if( enemies[11+ 2 ][11+ 3 ] != Sprite.KIND_SPIKY_WINGED ){ action[ Mario.KEY_LEFT ] = false ;
 action[ Mario.KEY_JUMP ] = false ;
 }else{ action[ Mario.KEY_SPEED ] = false ;
 } } if( enemies[11+ 0 ][11+ 1 ] != Sprite.KIND_RED_KOOPA_WINGED ){ action[ Mario.KEY_LEFT ] = false ;
 action[ Mario.KEY_RIGHT ] = true ;
 ...
 } } } if( landscape[11+ -2 ][11+ -3 ] != -11 ){ if( observation.mayMarioJump() ){ if( enemies[11+ 2 ][11+ 3 ] != Sprite.KIND_GREEN_KOOPA ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_JUMP ] = true ;
 ...
 } } if( enemies[11+ 2 ][11+ 0 ] != Sprite.KIND_SPIKY ){ if( enemies[11+ 3 ][11+ 3 ] != Sprite.KIND_GREEN_KOOPA_WINGED ){ if( observation.isMarioOnGround() ){ if( landscape[11+ 3 ][11+ 2 ] != 20 ){ action[ Mario.KEY_RIGHT ] = false ;
 } } } } if( enemies[11+ 1 ][11+ 3 ] != Sprite.KIND_GOOMBA_WINGED ){ if( landscape[11+ 0 ][11+ -3 ] != -10 ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_RIGHT ] = true ;
 } action[ Mario.KEY_JUMP ] = true ;
 action[ Mario.KEY_SPEED ] = true ;
