...
//                        show(cur_char);
 ...
 action[ Mario.KEY_RIGHT ] = true ;
 action[ Mario.KEY_DOWN ] = false ;
 } if( observation.isMarioOnGround() ){ if( landscape[11+ -1 ][11+ 1 ] != 1 ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_SPEED ] = false ;
 }else{ action[ Mario.KEY_SPEED ] = false ;
 } action[ Mario.KEY_RIGHT ] = true ;
 action[ Mario.KEY_DOWN ] = false ;
 action[ Mario.KEY_DOWN ] = true ;
 ...
 action[ Mario.KEY_JUMP ] = true ;
 } if( enemies[11+ 0 ][11+ 1 ] != 1 ){ if( enemies[11+ 0 ][11+ 0 ] != 1 ){ action[ Mario.KEY_LEFT ] = true ;
 action[ Mario.KEY_JUMP ] = false ;
