 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent166 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 } if( observation.mayMarioJump() ){ if( observation.isMarioOnGround() ){ if( observation.isMarioOnGround() ){ if( enemies[11+ 1 ][11+ 0 ] != 1 ){ action[ Mario.KEY_LEFT ] = false ;
 }else{ action[ Mario.KEY_JUMP ] = true ;
 ...
 } }else{ if( enemies[11+ 0 ][11+ 1 ] != 1 ){ if( enemies[11+ 0 ][11+ 0 ] != 1 ){ action[ Mario.KEY_LEFT ] = true ;
 }else{ action[ Mario.KEY_LEFT ] = false ;
 } }else{ action[ Mario.KEY_DOWN ] = false ;
 action[ Mario.KEY_LEFT ] = false ;
 } } } 	
