...
//                        show(cur_char);
 ...
 } } } } if( enemies[11+ 2 ][11+ 0 ] != Sprite.KIND_SPIKY ){ if( enemies[11+ 3 ][11+ 3 ] != Sprite.KIND_GREEN_KOOPA_WINGED ){ if( observation.mayMarioJump() ){ if( landscape[11+ -2 ][11+ -3 ] != 21 ){ action[ Mario.KEY_DOWN ] = false ;
 }else{ action[ Mario.KEY_JUMP ] = true ;
 } } } } if( enemies[11+ 1 ][11+ 3 ] != Sprite.KIND_GOOMBA ){ if( observation.isMarioOnGround() ){ if( observation.isMarioOnGround() ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_JUMP ] = true ;
 }else{ action[ Mario.KEY_LEFT ] = true ;
