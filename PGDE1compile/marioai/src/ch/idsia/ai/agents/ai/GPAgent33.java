...
//                        show(cur_char);
	...
	byte[][] landscape = observation.getLevelSceneObservation();// default: ZLevelScene = 1  
	 ...
	 if( enemies[11+ -1 ][11+ 1 ] != 1 ){ if( observation.isMarioOnGround() ){ if( landscape[11+ 1 ][11+ 0 ] != 1 ){ if( landscape[11+ -1 ][11+ 1 ] != 1 ){ action[ Mario.KEY_SPEED ] = false ;
 } action[ Mario.KEY_LEFT ] = false ;
 } action[ Mario.KEY_LEFT ] = true ;
 } if( enemies[11+ -1 ][11+ 0 ] != 1 ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_LEFT ] = true ;
 }else{ if( observation.isMarioOnGround() ){ if( enemies[11+ 1 ][11+ 1 ] != 1 ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_DOWN ] = false ;
