 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent33 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 } }else{ if( landscape[11+ 0 ][11+ 2 ] != 20 ){ action[ Mario.KEY_JUMP ] = true ;
 ...
 if( observation.mayMarioJump() ){ if( observation.isMarioOnGround() ){ if( enemies[11+ 3 ][11+ 0 ] != Sprite.KIND_GREEN_KOOPA_WINGED ){ action[ Mario.KEY_RIGHT ] = true ;
 ...
 } if( landscape[11+ -3 ][11+ 0 ] != 20 ){ action[ Mario.KEY_JUMP ] = true ;
