...
//                        show(cur_char);
 ...
 } if( landscape[11+ 0 ][11+ 0 ] != 1 ){ if( landscape[11+ 1 ][11+ 1 ] != 1 ){ action[ Mario.KEY_JUMP ] = false ;
 } action[ Mario.KEY_SPEED ] = true ;
 action[ Mario.KEY_SPEED ] = true ;
 ...
 } } }else{ if( observation.isMarioOnGround() ){ if( observation.isMarioOnGround() ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_RIGHT ] = false ;
 } } }else{ if( enemies[11+ -1 ][11+ 0 ] != 1 ){ if( landscape[11+ 0 ][11+ -1 ] != 1 ){ action[ Mario.KEY_DOWN ] = true ;
