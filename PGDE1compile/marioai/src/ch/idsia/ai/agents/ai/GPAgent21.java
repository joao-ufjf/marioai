 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent21 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 action[ Mario.KEY_DOWN ] = false ;
 } if( enemies[11+ 2 ][11+ 0 ] != Sprite.KIND_SPIKY ){ if( observation.isMarioOnGround() ){ if( observation.mayMarioJump() ){ if( landscape[11+ -2 ][11+ -2 ] != -11 ){ action[ Mario.KEY_JUMP ] = true ;
