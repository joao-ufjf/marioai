 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent728 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 } }else{ if( enemies[11+ 0 ][11+ 0 ] != 1 ){ action[ Mario.KEY_SPEED ] = false ;
 }else{ action[ Mario.KEY_RIGHT ] = false ;
 } } } }else{ if( enemies[11+ 0 ][11+ 0 ] != 1 ){ if( enemies[11+ 0 ][11+ 0 ] != 1 ){ action[ Mario.KEY_DOWN ] = false ;
 ...
 action[ Mario.KEY_LEFT ] = false ;
 } } }else{ if( enemies[11+ 0 ][11+ 0 ] != 1 ){ if( observation.isMarioOnGround() ){ if( enemies[11+ 0 ][11+ 1 ] != 1 ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_JUMP ] = true ;
 ...
 } } } if( enemies[11+ 1 ][11+ 0 ] != 1 ){ if( enemies[11+ -1 ][11+ 0 ] != 1 ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_DOWN ] = true ;
 }else{ action[ Mario.KEY_JUMP ] = false ;
 ...
 } } }else{ if( landscape[11+ -1 ][11+ 0 ] != 1 ){ if( landscape[11+ 0 ][11+ -1 ] != 1 ){ action[ Mario.KEY_SPEED ] = false ;
 }else{ action[ Mario.KEY_DOWN ] = true ;
 } action[ Mario.KEY_SPEED ] = true ;
 action[ Mario.KEY_LEFT ] = true ;
 }else{ action[ Mario.KEY_DOWN ] = true ;
 ...
 action[ Mario.KEY_JUMP ] = false ;
 action[ Mario.KEY_DOWN ] = true ;
 } if( landscape[11+ 1 ][11+ -1 ] != 1 ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_RIGHT ] = true ;
 action[ Mario.KEY_JUMP ] = false ;
 }else{ if( landscape[11+ 1 ][11+ 1 ] != 1 ){ action[ Mario.KEY_DOWN ] = true ;
 }else{ action[ Mario.KEY_LEFT ] = true ;
 ...
 } }else{ if( enemies[11+ 1 ][11+ 0 ] != 1 ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_LEFT ] = true ;
 }else{ action[ Mario.KEY_JUMP ] = false ;
 } }else{ action[ Mario.KEY_LEFT ] = false ;
 action[ Mario.KEY_SPEED ] = true ;
 } } if( landscape[11+ 0 ][11+ 1 ] != 1 ){ if( landscape[11+ 1 ][11+ 0 ] != 1 ){ action[ Mario.KEY_LEFT ] = true ;
 action[ Mario.KEY_RIGHT ] = false ;
