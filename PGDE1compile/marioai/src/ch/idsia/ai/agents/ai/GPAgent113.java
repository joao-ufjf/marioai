...
//                        show(cur_char);
 ...
 } if( landscape[11+ -2 ][11+ -2 ] != 0 ){ action[ Mario.KEY_JUMP ] = true ;
 ...
 } }else{ if( landscape[11+ -2 ][11+ 2 ] != -11 ){ action[ Mario.KEY_SPEED ] = false ;
 }else{ action[ Mario.KEY_RIGHT ] = false ;
 } } action[ Mario.KEY_DOWN ] = true ;
 action[ Mario.KEY_LEFT ] = true ;
 } if( enemies[11+ -1 ][11+ 1 ] != Sprite.KIND_BULLET_BILL ){ if( observation.isMarioOnGround() ){ if( enemies[11+ -2 ][11+ 0 ] != Sprite.KIND_SPIKY ){ action[ Mario.KEY_SPEED ] = false ;
 action[ Mario.KEY_JUMP ] = false ;
 }else{ action[ Mario.KEY_LEFT ] = true ;
 } }else{ action[ Mario.KEY_JUMP ] = false ;
 } }else{ if( observation.isMarioOnGround() ){ if( enemies[11+ -1 ][11+ 2 ] != Sprite.KIND_SPIKY ){ action[ Mario.KEY_LEFT ] = false ;
