 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent104 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
	...
	byte[][] landscape = observation.getLevelSceneObservation();// default: ZLevelScene = 1  
	 ...
	 if( observation.isMarioOnGround() ){ if( landscape[11+ 2 ][11+ 0 ] != 20 ){ action[ Mario.KEY_JUMP ] = true ;
 } if( observation.isMarioOnGround() ){ action[ Mario.KEY_RIGHT ] = true ;
 }else{ action[ Mario.KEY_LEFT ] = true ;
 } }else{ if( landscape[11+ 1 ][11+ 2 ] != -11 ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_JUMP ] = false ;
 ...
 } } } if( observation.mayMarioJump() ){ if( landscape[11+ -2 ][11+ -1 ] != 21 ){ if( enemies[11+ 3 ][11+ -3 ] != Sprite.KIND_BULLET_BILL ){ action[ Mario.KEY_LEFT ] = false ;
 ...
 } } if( landscape[11+ -1 ][11+ 0 ] != 0 ){ if( observation.isMarioOnGround() ){ if( landscape[11+ 3 ][11+ -3 ] != -11 ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_LEFT ] = false ;
 }else{ action[ Mario.KEY_RIGHT ] = true ;
 } } }else{ if( enemies[11+ -2 ][11+ 1 ] != Sprite.KIND_RED_KOOPA_WINGED ){ action[ Mario.KEY_JUMP ] = false ;
 action[ Mario.KEY_RIGHT ] = true ;
 } } } if( observation.mayMarioJump() ){ if( enemies[11+ 3 ][11+ -1 ] != Sprite.KIND_RED_KOOPA_WINGED ){ action[ Mario.KEY_SPEED ] = false ;
 } if( landscape[11+ -3 ][11+ -3 ] != 16 ){ action[ Mario.KEY_SPEED ] = true ;
 } }else{ if( observation.isMarioOnGround() ){ action[ Mario.KEY_DOWN ] = false ;
 }else{ action[ Mario.KEY_SPEED ] = false ;
 action[ Mario.KEY_DOWN ] = false ;
 } } if( landscape[11+ -2 ][11+ 2 ] != -11 ){ if( observation.mayMarioJump() ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_LEFT ] = true ;
 } }else{ if( observation.isMarioOnGround() ){ action[ Mario.KEY_RIGHT ] = true ;
 }else{ action[ Mario.KEY_DOWN ] = false ;
 } action[ Mario.KEY_DOWN ] = true ;
 action[ Mario.KEY_LEFT ] = true ;
 } } if( enemies[11+ -2 ][11+ 0 ] != Sprite.KIND_SPIKY ){ if( observation.isMarioOnGround() ){ if( observation.mayMarioJump() ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_LEFT ] = false ;
 } } } } if( enemies[11+ 1 ][11+ -1 ] != Sprite.KIND_BULLET_BILL ){ if( landscape[11+ 0 ][11+ 2 ] != 16 ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_SPEED ] = true ;
 action[ Mario.KEY_JUMP ] = true ;
 if( observation.isMarioOnGround() ){ action[ Mario.KEY_SPEED ] = true ;
 } } } }else{ if( enemies[11+ 1 ][11+ 3 ] != Sprite.KIND_RED_KOOPA ){ if( enemies[11+ 0 ][11+ -2 ] != Sprite.KIND_RED_KOOPA ){ action[ Mario.KEY_DOWN ] = false ;
 } }else{ if( enemies[11+ -1 ][11+ 2 ] != Sprite.KIND_GOOMBA_WINGED ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_RIGHT ] = false ;
 }else{ action[ Mario.KEY_DOWN ] = true ;
 } }else{ action[ Mario.KEY_SPEED ] = true ;
 action[ Mario.KEY_LEFT ] = false ;
 } } action[ Mario.KEY_LEFT ] = true ;
 if( enemies[11+ 3 ][11+ 1 ] != Sprite.KIND_GOOMBA ){ action[ Mario.KEY_JUMP ] = true ;
 }else{ action[ Mario.KEY_LEFT ] = true ;
 } if( enemies[11+ -2 ][11+ 3 ] != Sprite.KIND_GOOMBA ){ action[ Mario.KEY_DOWN ] = true ;
 } } 	
	//Begin of BGPAgent
	return action;
    }
