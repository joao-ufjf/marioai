...
//                        show(cur_char);
 ...
 if( enemies[11+ -1 ][11+ 0 ] != 1 ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_JUMP ] = false ;
 }else{ if( observation.mayMarioJump() ){ action[ Mario.KEY_SPEED ] = true ;
 }else{ action[ Mario.KEY_JUMP ] = false ;
 action[ Mario.KEY_SPEED ] = false ;
 action[ Mario.KEY_DOWN ] = true ;
 } } action[ Mario.KEY_LEFT ] = false ;
 }else{ if( landscape[11+ 0 ][11+ -1 ] != 1 ){ if( observation.isMarioOnGround() ){ if( enemies[11+ 0 ][11+ 0 ] != 1 ){ if( landscape[11+ 0 ][11+ 0 ] != 1 ){ action[ Mario.KEY_RIGHT ] = true ;
 }else{ action[ Mario.KEY_SPEED ] = false ;
 } } } } if( landscape[11+ -1 ][11+ -1 ] != 1 ){ if( enemies[11+ 0 ][11+ 0 ] != 1 ){ action[ Mario.KEY_DOWN ] = true ;
