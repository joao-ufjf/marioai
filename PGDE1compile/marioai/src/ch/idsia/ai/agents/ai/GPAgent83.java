 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent83 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 } } } }else{ if( observation.mayMarioJump() ){ if( observation.mayMarioJump() ){ if( landscape[11+ 0 ][11+ 0 ] != 21 ){ if( landscape[11+ 0 ][11+ -2 ] != -11 ){ action[ Mario.KEY_DOWN ] = true ;
