 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent82 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 } if( observation.isMarioOnGround() ){ if( enemies[11+ 0 ][11+ -2 ] != Sprite.KIND_GOOMBA ){ if( enemies[11+ -2 ][11+ 1 ] != Sprite.KIND_GOOMBA ){ if( observation.mayMarioJump() ){ if( landscape[11+ -3 ][11+ 0 ] != 21 ){ action[ Mario.KEY_RIGHT ] = false ;
 } }else{ if( observation.isMarioOnGround() ){ action[ Mario.KEY_LEFT ] = true ;
 }else{ action[ Mario.KEY_RIGHT ] = true ;
 } } } } } if( landscape[11+ -2 ][11+ -3 ] != -11 ){ if( observation.mayMarioJump() ){ if( landscape[11+ 0 ][11+ 3 ] != -11 ){ action[ Mario.KEY_JUMP ] = true ;
 ...
 action[ Mario.KEY_LEFT ] = true ;
 } } if( enemies[11+ -1 ][11+ 0 ] != Sprite.KIND_RED_KOOPA ){ if( observation.isMarioOnGround() ){ if( observation.mayMarioJump() ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_DOWN ] = true ;
 } } } } if( enemies[11+ 1 ][11+ 3 ] != Sprite.KIND_BULLET_BILL ){ if( landscape[11+ 1 ][11+ 2 ] != 21 ){ if( observation.isMarioOnGround() ){ if( enemies[11+ -2 ][11+ -3 ] != Sprite.KIND_GOOMBA ){ action[ Mario.KEY_JUMP ] = false ;
