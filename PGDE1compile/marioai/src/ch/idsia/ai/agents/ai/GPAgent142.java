 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent142 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 }else{ if( landscape[11+ -3 ][11+ 2 ] != -11 ){ action[ Mario.KEY_DOWN ] = false ;
 ...
 } } } if( observation.mayMarioJump() ){ if( enemies[11+ 1 ][11+ 0 ] != Sprite.KIND_SPIKY_WINGED ){ action[ Mario.KEY_RIGHT ] = true ;
 } if( enemies[11+ -1 ][11+ -3 ] != Sprite.KIND_SPIKY ){ action[ Mario.KEY_LEFT ] = true ;
 ...
 } } if( enemies[11+ 2 ][11+ 0 ] != Sprite.KIND_SPIKY ){ if( enemies[11+ 1 ][11+ 2 ] != Sprite.KIND_GREEN_KOOPA ){ action[ Mario.KEY_LEFT ] = true ;
 action[ Mario.KEY_SPEED ] = false ;
 } if( landscape[11+ -3 ][11+ 3 ] != 21 ){ action[ Mario.KEY_JUMP ] = false ;
