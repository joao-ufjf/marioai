 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent399 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
	...
	byte[][] landscape = observation.getLevelSceneObservation();// default: ZLevelScene = 1  
	 ...
	 if( landscape[11+ 0 ][11+ 1 ] != 1 ){ if( landscape[11+ 0 ][11+ 0 ] != 1 ){ if( landscape[11+ 0 ][11+ 1 ] != 1 ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_RIGHT ] = false ;
 ...
 } } } } }else{ if( observation.isMarioOnGround() ){ if( observation.isMarioOnGround() ){ if( landscape[11+ 0 ][11+ 1 ] != 1 ){ action[ Mario.KEY_DOWN ] = true ;
 ...
 } } if( observation.mayMarioJump() ){ if( enemies[11+ 1 ][11+ -1 ] != 1 ){ if( enemies[11+ 0 ][11+ 0 ] != 1 ){ action[ Mario.KEY_SPEED ] = true ;
 action[ Mario.KEY_DOWN ] = true ;
 }else{ if( observation.mayMarioJump() ){ action[ Mario.KEY_LEFT ] = false ;
