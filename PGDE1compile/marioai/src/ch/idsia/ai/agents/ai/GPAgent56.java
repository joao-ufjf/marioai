...
//                        show(cur_char);
 ...
 if( observation.mayMarioJump() ){ if( observation.mayMarioJump() ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_SPEED ] = false ;
 if( landscape[11+ -1 ][11+ 1 ] != 1 ){ if( enemies[11+ 1 ][11+ 0 ] != 1 ){ action[ Mario.KEY_RIGHT ] = false ;
 } } } } }else{ if( landscape[11+ 0 ][11+ 1 ] != 1 ){ if( enemies[11+ 0 ][11+ -1 ] != 1 ){ if( observation.isMarioOnGround() ){ if( enemies[11+ 0 ][11+ 1 ] != 1 ){ if( landscape[11+ -1 ][11+ -1 ] != 1 ){ action[ Mario.KEY_DOWN ] = true ;
