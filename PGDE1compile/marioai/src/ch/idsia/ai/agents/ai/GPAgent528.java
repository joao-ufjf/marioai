 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent528 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 }else{ if( landscape[11+ -1 ][11+ 0 ] != 1 ){ if( landscape[11+ 1 ][11+ 0 ] != 1 ){ if( observation.isMarioOnGround() ){ if( landscape[11+ 1 ][11+ 0 ] != 1 ){ action[ Mario.KEY_DOWN ] = true ;
 ...
 } } }else{ if( enemies[11+ 1 ][11+ 0 ] != 1 ){ if( landscape[11+ 1 ][11+ -1 ] != 1 ){ action[ Mario.KEY_RIGHT ] = false ;
