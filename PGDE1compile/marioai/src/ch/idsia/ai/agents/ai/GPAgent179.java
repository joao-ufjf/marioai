...
//                        show(cur_char);
 ...
 } if( observation.isMarioOnGround() ){ if( observation.isMarioOnGround() ){ if( landscape[11+ 1 ][11+ 2 ] != 16 ){ action[ Mario.KEY_DOWN ] = true ;
 }else{ action[ Mario.KEY_JUMP ] = false ;
 ...
 } if( enemies[11+ 1 ][11+ -1 ] != Sprite.KIND_RED_KOOPA ){ action[ Mario.KEY_JUMP ] = true ;
 action[ Mario.KEY_SPEED ] = false ;
 }else{ action[ Mario.KEY_RIGHT ] = true ;
 action[ Mario.KEY_DOWN ] = false ;
 } } 	
