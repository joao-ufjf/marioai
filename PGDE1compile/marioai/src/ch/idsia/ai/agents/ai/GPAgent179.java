 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent179 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
	...
	byte[][] landscape = observation.getLevelSceneObservation();// default: ZLevelScene = 1  
	 ...
	 if( enemies[11+ 3 ][11+ -2 ] != Sprite.KIND_RED_KOOPA ){ action[ Mario.KEY_RIGHT ] = true ;
 ...
 } if( observation.isMarioOnGround() ){ if( enemies[11+ 1 ][11+ -3 ] != Sprite.KIND_GOOMBA ){ if( observation.mayMarioJump() ){ if( landscape[11+ -2 ][11+ 2 ] != -10 ){ action[ Mario.KEY_LEFT ] = false ;
 ...
 } } } } if( enemies[11+ 1 ][11+ 3 ] != Sprite.KIND_BULLET_BILL ){ if( landscape[11+ 1 ][11+ 3 ] != 21 ){ if( observation.isMarioOnGround() ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_SPEED ] = true ;
 } action[ Mario.KEY_JUMP ] = true ;
 } } }else{ if( observation.mayMarioJump() ){ if( observation.mayMarioJump() ){ if( enemies[11+ -1 ][11+ -2 ] != Sprite.KIND_RED_KOOPA ){ action[ Mario.KEY_DOWN ] = false ;
