...
//                        show(cur_char);
	...
	byte[][] landscape = observation.getLevelSceneObservation();// default: ZLevelScene = 1  
	 ...
	 if( observation.mayMarioJump() ){ if( observation.isMarioOnGround() ){ if( observation.isMarioOnGround() ){ if( landscape[11+ 1 ][11+ 1 ] != 16 ){ action[ Mario.KEY_SPEED ] = true ;
 action[ Mario.KEY_SPEED ] = true ;
 ...
 } } if( observation.isMarioOnGround() ){ if( observation.isMarioOnGround() ){ if( enemies[11+ -2 ][11+ -2 ] != Sprite.KIND_BULLET_BILL ){ action[ Mario.KEY_LEFT ] = false ;
 } if( landscape[11+ -2 ][11+ -2 ] != 0 ){ action[ Mario.KEY_JUMP ] = false ;
