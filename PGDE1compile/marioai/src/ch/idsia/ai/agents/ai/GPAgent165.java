 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent165 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 } } } if( observation.mayMarioJump() ){ if( landscape[11+ 1 ][11+ 0 ] != -10 ){ if( enemies[11+ -3 ][11+ 3 ] != Sprite.KIND_RED_KOOPA ){ if( enemies[11+ 2 ][11+ -2 ] != Sprite.KIND_GREEN_KOOPA_WINGED ){ action[ Mario.KEY_SPEED ] = false ;
