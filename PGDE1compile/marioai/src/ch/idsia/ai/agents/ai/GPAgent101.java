 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent101 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 } } } if( observation.isMarioOnGround() ){ if( enemies[11+ -2 ][11+ 3 ] != Sprite.KIND_GOOMBA ){ action[ Mario.KEY_DOWN ] = false ;
 } action[ Mario.KEY_DOWN ] = false ;
 ...
 } }else{ if( landscape[11+ 3 ][11+ -3 ] != -10 ){ action[ Mario.KEY_DOWN ] = false ;
