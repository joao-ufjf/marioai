 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent470 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 }else{ if( observation.isMarioOnGround() ){ if( observation.isMarioOnGround() ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_DOWN ] = false ;
 }else{ action[ Mario.KEY_JUMP ] = false ;
 } }else{ action[ Mario.KEY_JUMP ] = false ;
