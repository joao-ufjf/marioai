...
//                        show(cur_char);
 ...
 } }else{ if( landscape[11+ 0 ][11+ 2 ] != 0 ){ action[ Mario.KEY_JUMP ] = true ;
 ...
 if( enemies[11+ -3 ][11+ -3 ] != Sprite.KIND_BULLET_BILL ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_JUMP ] = false ;
 }else{ action[ Mario.KEY_RIGHT ] = false ;
