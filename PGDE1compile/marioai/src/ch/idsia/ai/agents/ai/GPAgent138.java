...
//                        show(cur_char);
	...
	byte[][] landscape = observation.getLevelSceneObservation();// default: ZLevelScene = 1  
	 ...
	 if( observation.mayMarioJump() ){ if( observation.mayMarioJump() ){ if( observation.isMarioOnGround() ){ if( landscape[11+ 1 ][11+ -2 ] != 16 ){ if( landscape[11+ 1 ][11+ 0 ] != -11 ){ if( enemies[11+ 0 ][11+ 1 ] != Sprite.KIND_SPIKY ){ action[ Mario.KEY_RIGHT ] = true ;
 ...
 action[ Mario.KEY_SPEED ] = true ;
 }else{ if( observation.isMarioOnGround() ){ if( landscape[11+ -2 ][11+ 2 ] != 20 ){ action[ Mario.KEY_LEFT ] = false ;
 } }else{ if( landscape[11+ -1 ][11+ 0 ] != 20 ){ if( enemies[11+ 2 ][11+ 0 ] != Sprite.KIND_GOOMBA_WINGED ){ action[ Mario.KEY_JUMP ] = true ;
 }else{ action[ Mario.KEY_SPEED ] = false ;
 } } action[ Mario.KEY_LEFT ] = true ;
 action[ Mario.KEY_DOWN ] = false ;
 } action[ Mario.KEY_SPEED ] = true ;
