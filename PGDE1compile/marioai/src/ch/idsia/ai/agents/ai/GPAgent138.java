 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent138 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 } } if( landscape[11+ -3 ][11+ 3 ] != 16 ){ if( landscape[11+ 1 ][11+ 2 ] != -10 ){ if( enemies[11+ -3 ][11+ 3 ] != Sprite.KIND_RED_KOOPA ){ if( landscape[11+ -2 ][11+ 1 ] != 20 ){ action[ Mario.KEY_JUMP ] = true ;
