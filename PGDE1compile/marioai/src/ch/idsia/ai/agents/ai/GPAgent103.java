 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent103 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 } } if( observation.isMarioOnGround() ){ if( enemies[11+ 0 ][11+ -2 ] != Sprite.KIND_GOOMBA ){ if( enemies[11+ -3 ][11+ 0 ] != Sprite.KIND_GREEN_KOOPA ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_LEFT ] = true ;
 ...
 } if( observation.mayMarioJump() ){ if( landscape[11+ -3 ][11+ 2 ] != 0 ){ action[ Mario.KEY_LEFT ] = false ;
