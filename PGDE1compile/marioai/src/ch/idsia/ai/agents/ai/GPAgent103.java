...
//                        show(cur_char);
	...
	byte[][] landscape = observation.getLevelSceneObservation();// default: ZLevelScene = 1  
	 ...
	 if( enemies[11+ -1 ][11+ -2 ] != Sprite.KIND_RED_KOOPA ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_LEFT ] = true ;
 }else{ action[ Mario.KEY_LEFT ] = true ;
 } }else{ action[ Mario.KEY_SPEED ] = true ;
 } if( landscape[11+ 1 ][11+ 1 ] != 16 ){ if( landscape[11+ 1 ][11+ 0 ] != -11 ){ action[ Mario.KEY_JUMP ] = true ;
 } }else{ if( observation.isMarioOnGround() ){ action[ Mario.KEY_JUMP ] = false ;
 }else{ action[ Mario.KEY_DOWN ] = true ;
 } } if( enemies[11+ -2 ][11+ -1 ] != Sprite.KIND_SPIKY_WINGED ){ if( observation.isMarioOnGround() ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_DOWN ] = false ;
 }else{ action[ Mario.KEY_LEFT ] = true ;
 ...
 } } if( observation.isMarioOnGround() ){ if( enemies[11+ -1 ][11+ 2 ] != Sprite.KIND_GREEN_KOOPA ){ if( landscape[11+ 2 ][11+ 1 ] != 16 ){ action[ Mario.KEY_RIGHT ] = true ;
 ...
 } } } } if( landscape[11+ -1 ][11+ 2 ] != 20 ){ if( enemies[11+ 2 ][11+ -1 ] != Sprite.KIND_GOOMBA ){ if( landscape[11+ -2 ][11+ 1 ] != 20 ){ if( landscape[11+ -1 ][11+ 2 ] != 20 ){ action[ Mario.KEY_JUMP ] = false ;
 } }else{ action[ Mario.KEY_SPEED ] = true ;
 } } } 	
	//Begin of BGPAgent
	return action;
