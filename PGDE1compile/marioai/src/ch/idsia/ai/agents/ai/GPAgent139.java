...
//                        show(cur_char);
 ...
 } } } if( observation.mayMarioJump() ){ if( enemies[11+ -3 ][11+ -3 ] != Sprite.KIND_GREEN_KOOPA ){ action[ Mario.KEY_JUMP ] = false ;
 ...
 } } } if( observation.isMarioOnGround() ){ if( enemies[11+ 0 ][11+ -3 ] != Sprite.KIND_RED_KOOPA_WINGED ){ if( observation.isMarioOnGround() ){ if( landscape[11+ -3 ][11+ -3 ] != 16 ){ action[ Mario.KEY_RIGHT ] = true ;
