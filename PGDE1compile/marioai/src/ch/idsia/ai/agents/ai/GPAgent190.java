 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent190 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 }else{ if( observation.isMarioOnGround() ){ if( observation.mayMarioJump() ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_SPEED ] = false ;
 ...
 action[ Mario.KEY_RIGHT ] = true ;
 } } } if( observation.mayMarioJump() ){ if( enemies[11+ 3 ][11+ -1 ] != Sprite.KIND_RED_KOOPA_WINGED ){ action[ Mario.KEY_JUMP ] = false ;
