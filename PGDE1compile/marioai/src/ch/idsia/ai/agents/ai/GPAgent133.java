...
//                        show(cur_char);
	...
	byte[][] landscape = observation.getLevelSceneObservation();// default: ZLevelScene = 1  
	 ...
	 if( observation.mayMarioJump() ){ if( enemies[11+ 1 ][11+ 2 ] != Sprite.KIND_SPIKY ){ if( observation.isMarioOnGround() ){ if( landscape[11+ -1 ][11+ -2 ] != 16 ){ action[ Mario.KEY_LEFT ] = false ;
 ...
 } } if( observation.isMarioOnGround() ){ if( enemies[11+ -2 ][11+ 2 ] != Sprite.KIND_RED_KOOPA ){ if( enemies[11+ 1 ][11+ -2 ] != Sprite.KIND_GOOMBA ){ action[ Mario.KEY_RIGHT ] = false ;
 } if( landscape[11+ -2 ][11+ -2 ] != 0 ){ action[ Mario.KEY_RIGHT ] = false ;
 }else{ action[ Mario.KEY_LEFT ] = true ;
 } } } }else{ if( enemies[11+ -1 ][11+ -1 ] != Sprite.KIND_GREEN_KOOPA ){ action[ Mario.KEY_DOWN ] = true ;
