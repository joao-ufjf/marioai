 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent133 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 } } } if( observation.mayMarioJump() ){ if( enemies[11+ 1 ][11+ 0 ] != Sprite.KIND_SPIKY_WINGED ){ action[ Mario.KEY_RIGHT ] = false ;
 } if( enemies[11+ -1 ][11+ -1 ] != Sprite.KIND_SPIKY ){ action[ Mario.KEY_LEFT ] = true ;
 ...
 } } } if( observation.isMarioOnGround() ){ if( enemies[11+ 0 ][11+ -3 ] != Sprite.KIND_GOOMBA ){ if( enemies[11+ -1 ][11+ -1 ] != Sprite.KIND_GOOMBA ){ if( observation.mayMarioJump() ){ if( landscape[11+ -3 ][11+ -1 ] != 0 ){ action[ Mario.KEY_DOWN ] = false ;
 }else{ action[ Mario.KEY_DOWN ] = true ;
 } } } } } if( landscape[11+ -2 ][11+ -3 ] != -11 ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_JUMP ] = false ;
 if( observation.mayMarioJump() ){ action[ Mario.KEY_SPEED ] = false ;
 }else{ action[ Mario.KEY_DOWN ] = true ;
 } }else{ if( enemies[11+ -1 ][11+ -3 ] != Sprite.KIND_SPIKY ){ if( landscape[11+ -2 ][11+ -3 ] != -10 ){ action[ Mario.KEY_JUMP ] = false ;
 }else{ action[ Mario.KEY_RIGHT ] = true ;
 } }else{ if( enemies[11+ -3 ][11+ 3 ] != Sprite.KIND_BULLET_BILL ){ action[ Mario.KEY_DOWN ] = false ;
 }else{ action[ Mario.KEY_JUMP ] = true ;
 } } } } if( enemies[11+ 3 ][11+ 0 ] != Sprite.KIND_SPIKY ){ if( observation.isMarioOnGround() ){ if( observation.mayMarioJump() ){ if( enemies[11+ 0 ][11+ 3 ] != Sprite.KIND_GREEN_KOOPA_WINGED ){ action[ Mario.KEY_SPEED ] = true ;
 }else{ action[ Mario.KEY_JUMP ] = false ;
 } } } } if( landscape[11+ -3 ][11+ -1 ] != 16 ){ if( landscape[11+ 1 ][11+ 1 ] != -10 ){ if( observation.mayMarioJump() ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_LEFT ] = true ;
 } if( landscape[11+ 2 ][11+ 0 ] != 0 ){ action[ Mario.KEY_RIGHT ] = false ;
