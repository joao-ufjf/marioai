 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent182 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 } } if( landscape[11+ -1 ][11+ 0 ] != 0 ){ if( observation.isMarioOnGround() ){ if( landscape[11+ -1 ][11+ -3 ] != -11 ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_LEFT ] = true ;
 }else{ action[ Mario.KEY_RIGHT ] = true ;
