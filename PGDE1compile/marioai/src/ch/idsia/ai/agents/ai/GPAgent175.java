 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent175 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 } } }else{ if( landscape[11+ 1 ][11+ -2 ] != 0 ){ if( landscape[11+ -2 ][11+ -1 ] != 20 ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_RIGHT ] = false ;
 ...
 } }else{ if( landscape[11+ 2 ][11+ 2 ] != 0 ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_LEFT ] = false ;
 }else{ action[ Mario.KEY_JUMP ] = true ;
 ...
 } }else{ if( landscape[11+ 0 ][11+ 0 ] != -11 ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_RIGHT ] = true ;
