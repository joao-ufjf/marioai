 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent115 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 } if( observation.mayMarioJump() ){ if( enemies[11+ 3 ][11+ 3 ] != Sprite.KIND_GREEN_KOOPA_WINGED ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_RIGHT ] = false ;
 action[ Mario.KEY_DOWN ] = false ;
