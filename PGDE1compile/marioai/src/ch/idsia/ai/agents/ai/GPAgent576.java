 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent576 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
	...
	byte[][] landscape = observation.getLevelSceneObservation();// default: ZLevelScene = 1  
	 ...
	 if( enemies[11+ 1 ][11+ 0 ] != 1 ){ if( observation.mayMarioJump() ){ if( landscape[11+ -1 ][11+ 0 ] != 1 ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_LEFT ] = false ;
 ...
 } } } }else{ if( landscape[11+ -1 ][11+ 1 ] != 1 ){ if( enemies[11+ 1 ][11+ 1 ] != 1 ){ action[ Mario.KEY_DOWN ] = false ;
 ...
 action[ Mario.KEY_LEFT ] = false ;
 } }else{ if( observation.mayMarioJump() ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_LEFT ] = false ;
 action[ Mario.KEY_DOWN ] = true ;
 }else{ action[ Mario.KEY_JUMP ] = true ;
 ...
 action[ Mario.KEY_DOWN ] = false ;
 } } if( observation.mayMarioJump() ){ if( enemies[11+ -1 ][11+ -1 ] != 1 ){ action[ Mario.KEY_SPEED ] = false ;
 }else{ action[ Mario.KEY_DOWN ] = false ;
 ...
 action[ Mario.KEY_SPEED ] = false ;
 action[ Mario.KEY_SPEED ] = true ;
 } } }else{ if( landscape[11+ 1 ][11+ 1 ] != 1 ){ if( observation.isMarioOnGround() ){ if( enemies[11+ -1 ][11+ 0 ] != 1 ){ action[ Mario.KEY_SPEED ] = true ;
 }else{ action[ Mario.KEY_SPEED ] = false ;
 } }else{ action[ Mario.KEY_SPEED ] = true ;
 action[ Mario.KEY_SPEED ] = false ;
 ...
 action[ Mario.KEY_JUMP ] = false ;
 if( enemies[11+ 0 ][11+ 0 ] != 1 ){ if( observation.mayMarioJump() ){ if( enemies[11+ 0 ][11+ -1 ] != 1 ){ if( enemies[11+ 1 ][11+ 0 ] != 1 ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_JUMP ] = false ;
 }else{ action[ Mario.KEY_RIGHT ] = true ;
 ...
 if( observation.mayMarioJump() ){ action[ Mario.KEY_DOWN ] = true ;
 action[ Mario.KEY_LEFT ] = true ;
 }else{ if( enemies[11+ 1 ][11+ 0 ] != 1 ){ action[ Mario.KEY_LEFT ] = false ;
 }else{ action[ Mario.KEY_SPEED ] = false ;
 } } } }else{ if( observation.mayMarioJump() ){ if( landscape[11+ 1 ][11+ 1 ] != 1 ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_DOWN ] = false ;
 }else{ action[ Mario.KEY_SPEED ] = false ;
 ...
 } } if( enemies[11+ 0 ][11+ 1 ] != 1 ){ if( enemies[11+ 1 ][11+ 1 ] != 1 ){ action[ Mario.KEY_RIGHT ] = true ;
 }else{ action[ Mario.KEY_LEFT ] = true ;
 } if( observation.mayMarioJump() ){ action[ Mario.KEY_RIGHT ] = false ;
 }else{ action[ Mario.KEY_SPEED ] = true ;
 } }else{ if( landscape[11+ 0 ][11+ -1 ] != 1 ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_DOWN ] = false ;
 }else{ action[ Mario.KEY_JUMP ] = true ;
 } }else{ if( observation.mayMarioJump() ){ action[ Mario.KEY_JUMP ] = false ;
 }else{ action[ Mario.KEY_RIGHT ] = false ;
 } } } } } 	
