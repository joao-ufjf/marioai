...
//                        show(cur_char);
	...
	byte[][] landscape = observation.getLevelSceneObservation();// default: ZLevelScene = 1  
	 ...
	 if( landscape[11+ 0 ][11+ 1 ] != 20 ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_RIGHT ] = true ;
 }else{ action[ Mario.KEY_LEFT ] = true ;
 } }else{ action[ Mario.KEY_SPEED ] = true ;
 } if( landscape[11+ 0 ][11+ 0 ] != 0 ){ action[ Mario.KEY_RIGHT ] = false ;
 action[ Mario.KEY_RIGHT ] = true ;
 ...
 } } } } if( landscape[11+ -1 ][11+ 1 ] != 0 ){ if( enemies[11+ 2 ][11+ -1 ] != Sprite.KIND_RED_KOOPA_WINGED ){ if( landscape[11+ -2 ][11+ 1 ] != -10 ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_JUMP ] = false ;
 } }else{ if( enemies[11+ -2 ][11+ 0 ] != Sprite.KIND_SPIKY ){ action[ Mario.KEY_SPEED ] = false ;
