...
//                        show(cur_char);
	...
	byte[][] landscape = observation.getLevelSceneObservation();// default: ZLevelScene = 1  
	 ...
	 if( enemies[11+ 3 ][11+ -2 ] != Sprite.KIND_RED_KOOPA ){ action[ Mario.KEY_LEFT ] = false ;
 ...
 } } if( enemies[11+ 0 ][11+ 3 ] != Sprite.KIND_BULLET_BILL ){ if( landscape[11+ 1 ][11+ 3 ] != -10 ){ if( observation.isMarioOnGround() ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_SPEED ] = true ;
