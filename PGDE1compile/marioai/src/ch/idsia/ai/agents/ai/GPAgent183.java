 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent183 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 } } if( landscape[11+ 0 ][11+ 0 ] != 1 ){ if( observation.mayMarioJump() ){ if( landscape[11+ -1 ][11+ -1 ] != 1 ){ action[ Mario.KEY_LEFT ] = true ;
 }else{ action[ Mario.KEY_DOWN ] = false ;
 } }else{ action[ Mario.KEY_RIGHT ] = false ;
