 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent120 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 } } if( landscape[11+ -1 ][11+ 0 ] != 0 ){ if( observation.isMarioOnGround() ){ if( landscape[11+ 0 ][11+ 3 ] != 20 ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_LEFT ] = false ;
 }else{ action[ Mario.KEY_RIGHT ] = true ;
 ...
 } } if( landscape[11+ -2 ][11+ 2 ] != -11 ){ if( observation.mayMarioJump() ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_DOWN ] = false ;
 ...
 } } } } if( landscape[11+ 1 ][11+ 3 ] != 0 ){ if( landscape[11+ 0 ][11+ 2 ] != 16 ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_SPEED ] = true ;
 action[ Mario.KEY_JUMP ] = true ;
