...
//                        show(cur_char);
	...
	byte[][] landscape = observation.getLevelSceneObservation();// default: ZLevelScene = 1  
	 ...
	 if( enemies[11+ 3 ][11+ 0 ] != Sprite.KIND_GOOMBA ){ if( observation.mayMarioJump() ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_JUMP ] = true ;
 }else{ action[ Mario.KEY_DOWN ] = false ;
 } }else{ action[ Mario.KEY_DOWN ] = false ;
 action[ Mario.KEY_DOWN ] = true ;
 } }else{ if( landscape[11+ 1 ][11+ 2 ] != -10 ){ action[ Mario.KEY_SPEED ] = false ;
 ...
 } } } if( observation.isMarioOnGround() ){ if( landscape[11+ 1 ][11+ 1 ] != 0 ){ if( observation.mayMarioJump() ){ if( landscape[11+ -3 ][11+ -3 ] != 16 ){ action[ Mario.KEY_RIGHT ] = true ;
