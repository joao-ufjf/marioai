...
//                        show(cur_char);
	...
	byte[][] landscape = observation.getLevelSceneObservation();// default: ZLevelScene = 1  
	 ...
	 if( observation.mayMarioJump() ){ if( observation.isMarioOnGround() ){ if( observation.mayMarioJump() ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_LEFT ] = true ;
 ...
 } if( landscape[11+ 0 ][11+ 0 ] != -10 ){ action[ Mario.KEY_LEFT ] = true ;
 } } } } 	
	//Begin of BGPAgent
	return action;
    }
