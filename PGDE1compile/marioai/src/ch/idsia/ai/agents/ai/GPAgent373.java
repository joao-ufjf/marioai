 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent373 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 action[ Mario.KEY_JUMP ] = true ;
 } if( enemies[11+ -1 ][11+ 0 ] != 1 ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_RIGHT ] = true ;
 ...
 action[ Mario.KEY_RIGHT ] = false ;
 if( enemies[11+ -1 ][11+ 0 ] != 1 ){ if( landscape[11+ 0 ][11+ 1 ] != 1 ){ action[ Mario.KEY_LEFT ] = false ;
 }else{ action[ Mario.KEY_DOWN ] = false ;
 ...
 action[ Mario.KEY_JUMP ] = true ;
 } if( landscape[11+ 1 ][11+ -1 ] != 1 ){ if( enemies[11+ 0 ][11+ 0 ] != 1 ){ action[ Mario.KEY_JUMP ] = false ;
 action[ Mario.KEY_RIGHT ] = true ;
 }else{ action[ Mario.KEY_JUMP ] = false ;
 action[ Mario.KEY_SPEED ] = true ;
