 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent527 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
	...
	byte[][] landscape = observation.getLevelSceneObservation();// default: ZLevelScene = 1  
	 ...
	 if( observation.mayMarioJump() ){ if( observation.mayMarioJump() ){ if( observation.isMarioOnGround() ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_JUMP ] = true ;
 }else{ action[ Mario.KEY_JUMP ] = true ;
 } }else{ action[ Mario.KEY_DOWN ] = false ;
 action[ Mario.KEY_RIGHT ] = true ;
 } if( observation.mayMarioJump() ){ if( landscape[11+ 0 ][11+ 1 ] != 1 ){ action[ Mario.KEY_SPEED ] = true ;
 }else{ action[ Mario.KEY_JUMP ] = true ;
 ...
 } if( enemies[11+ -1 ][11+ 1 ] != 1 ){ if( landscape[11+ 1 ][11+ 1 ] != 1 ){ action[ Mario.KEY_RIGHT ] = true ;
 ...
 } } if( enemies[11+ 1 ][11+ 0 ] != 1 ){ if( enemies[11+ 0 ][11+ -1 ] != 1 ){ action[ Mario.KEY_RIGHT ] = false ;
 }else{ action[ Mario.KEY_DOWN ] = false ;
 ...
 } } if( observation.mayMarioJump() ){ if( landscape[11+ 1 ][11+ 0 ] != 1 ){ if( landscape[11+ 1 ][11+ 1 ] != 1 ){ action[ Mario.KEY_DOWN ] = true ;
