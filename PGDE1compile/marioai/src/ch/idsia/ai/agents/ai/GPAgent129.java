...
//                        show(cur_char);
	...
	byte[][] landscape = observation.getLevelSceneObservation();// default: ZLevelScene = 1  
	 ...
	 if( observation.mayMarioJump() ){ if( enemies[11+ 2 ][11+ -1 ] != Sprite.KIND_SPIKY ){ if( observation.mayMarioJump() ){ if( landscape[11+ -1 ][11+ 1 ] != 16 ){ action[ Mario.KEY_SPEED ] = true ;
 ...
 } } }else{ if( enemies[11+ 2 ][11+ -1 ] != Sprite.KIND_GOOMBA ){ if( landscape[11+ -2 ][11+ -1 ] != 20 ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_RIGHT ] = false ;
