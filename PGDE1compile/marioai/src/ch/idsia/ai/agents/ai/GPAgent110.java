 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent110 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 } } }else{ if( enemies[11+ 0 ][11+ 1 ] != Sprite.KIND_RED_KOOPA_WINGED ){ action[ Mario.KEY_JUMP ] = false ;
 action[ Mario.KEY_RIGHT ] = true ;
 ...
 } } if( landscape[11+ -2 ][11+ 2 ] != -11 ){ if( observation.mayMarioJump() ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_JUMP ] = true ;
 ...
 } }else{ if( enemies[11+ -1 ][11+ 2 ] != Sprite.KIND_RED_KOOPA ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_RIGHT ] = false ;
 }else{ action[ Mario.KEY_DOWN ] = true ;
