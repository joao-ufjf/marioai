...
//                        show(cur_char);
	...
	byte[][] landscape = observation.getLevelSceneObservation();// default: ZLevelScene = 1  
	 ...
	 if( observation.mayMarioJump() ){ if( enemies[11+ 1 ][11+ -1 ] != Sprite.KIND_SPIKY ){ if( observation.mayMarioJump() ){ if( landscape[11+ -1 ][11+ 1 ] != 16 ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_LEFT ] = false ;
 ...
 } } if( landscape[11+ -2 ][11+ -2 ] != 0 ){ if( enemies[11+ 1 ][11+ 0 ] != Sprite.KIND_RED_KOOPA_WINGED ){ action[ Mario.KEY_DOWN ] = false ;
 } } }else{ if( landscape[11+ 1 ][11+ -2 ] != -11 ){ if( landscape[11+ -2 ][11+ -1 ] != 20 ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_RIGHT ] = false ;
 } if( landscape[11+ -2 ][11+ -1 ] != 16 ){ action[ Mario.KEY_RIGHT ] = true ;
