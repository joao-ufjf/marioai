...
//                        show(cur_char);
	...
	byte[][] landscape = observation.getLevelSceneObservation();// default: ZLevelScene = 1  
	 ...
	 if( landscape[11+ 0 ][11+ -1 ] != 1 ){ if( observation.isMarioOnGround() ){ if( observation.isMarioOnGround() ){ if( landscape[11+ -1 ][11+ 0 ] != 1 ){ action[ Mario.KEY_RIGHT ] = false ;
 }else{ action[ Mario.KEY_SPEED ] = true ;
 } }else{ if( landscape[11+ 0 ][11+ 1 ] != 1 ){ action[ Mario.KEY_RIGHT ] = true ;
 }else{ action[ Mario.KEY_LEFT ] = true ;
 } } } }else{ if( enemies[11+ 0 ][11+ -1 ] != 1 ){ if( landscape[11+ 0 ][11+ 0 ] != 1 ){ action[ Mario.KEY_RIGHT ] = false ;
 ...
 } if( enemies[11+ -1 ][11+ 0 ] != 1 ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_RIGHT ] = false ;
 }else{ action[ Mario.KEY_SPEED ] = true ;
