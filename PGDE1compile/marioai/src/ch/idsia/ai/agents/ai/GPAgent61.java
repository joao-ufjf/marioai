 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent61 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 action[ Mario.KEY_DOWN ] = false ;
 } if( enemies[11+ -1 ][11+ 0 ] != Sprite.KIND_SPIKY ){ if( observation.isMarioOnGround() ){ if( observation.isMarioOnGround() ){ if( landscape[11+ -1 ][11+ -2 ] != 21 ){ action[ Mario.KEY_JUMP ] = true ;
