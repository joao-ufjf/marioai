...
//                        show(cur_char);
	...
	byte[][] landscape = observation.getLevelSceneObservation();// default: ZLevelScene = 1  
	 ...
	 if( observation.mayMarioJump() ){ if( observation.mayMarioJump() ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_RIGHT ] = false ;
 } action[ Mario.KEY_RIGHT ] = true ;
 } } if( observation.mayMarioJump() ){ if( landscape[11+ -3 ][11+ 2 ] != 0 ){ action[ Mario.KEY_LEFT ] = false ;
 } } if( observation.isMarioOnGround() ){ if( enemies[11+ 0 ][11+ -2 ] != Sprite.KIND_GOOMBA ){ if( enemies[11+ 3 ][11+ 0 ] != Sprite.KIND_RED_KOOPA_WINGED ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_SPEED ] = false ;
 ...
 } } } if( enemies[11+ -1 ][11+ -3 ] != Sprite.KIND_RED_KOOPA_WINGED ){ if( observation.mayMarioJump() ){ if( landscape[11+ 1 ][11+ -2 ] != 0 ){ action[ Mario.KEY_RIGHT ] = false ;
