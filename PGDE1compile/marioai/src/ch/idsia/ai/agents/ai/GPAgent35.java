 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent35 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 } } } } if( enemies[11+ 2 ][11+ 0 ] != Sprite.KIND_SPIKY ){ if( observation.mayMarioJump() ){ if( observation.mayMarioJump() ){ if( landscape[11+ 1 ][11+ 2 ] != 21 ){ action[ Mario.KEY_JUMP ] = true ;
