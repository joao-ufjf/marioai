...
//                        show(cur_char);
 ...
 } }else{ if( enemies[11+ 0 ][11+ -1 ] != Sprite.KIND_RED_KOOPA_WINGED ){ action[ Mario.KEY_SPEED ] = true ;
 ...
 } } } if( landscape[11+ -2 ][11+ 1 ] != -11 ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_RIGHT ] = false ;
