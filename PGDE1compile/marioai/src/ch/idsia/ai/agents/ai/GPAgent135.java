...
//                        show(cur_char);
 ...
 } } } } }else{ if( landscape[11+ 1 ][11+ -1 ] != 16 ){ if( landscape[11+ 1 ][11+ 0 ] != -11 ){ action[ Mario.KEY_JUMP ] = false ;
 action[ Mario.KEY_SPEED ] = true ;
 } }else{ action[ Mario.KEY_DOWN ] = false ;
 } } if( enemies[11+ -2 ][11+ 1 ] != Sprite.KIND_SPIKY_WINGED ){ action[ Mario.KEY_LEFT ] = true ;
