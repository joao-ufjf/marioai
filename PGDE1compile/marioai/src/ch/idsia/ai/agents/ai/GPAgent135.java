 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent135 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 } } } if( observation.isMarioOnGround() ){ if( enemies[11+ 0 ][11+ -3 ] != Sprite.KIND_GOOMBA ){ if( enemies[11+ -1 ][11+ -1 ] != Sprite.KIND_GOOMBA ){ action[ Mario.KEY_LEFT ] = false ;
 ...
 } } if( enemies[11+ 2 ][11+ 2 ] != Sprite.KIND_SPIKY ){ if( observation.isMarioOnGround() ){ if( observation.mayMarioJump() ){ if( enemies[11+ 3 ][11+ 3 ] != Sprite.KIND_GREEN_KOOPA_WINGED ){ action[ Mario.KEY_SPEED ] = true ;
 }else{ action[ Mario.KEY_JUMP ] = false ;
 } } } } if( landscape[11+ -3 ][11+ -1 ] != 16 ){ if( landscape[11+ 1 ][11+ 1 ] != -10 ){ if( enemies[11+ -3 ][11+ 0 ] != Sprite.KIND_RED_KOOPA ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_LEFT ] = true ;
