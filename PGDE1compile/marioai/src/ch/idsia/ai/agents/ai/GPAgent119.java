...
//                        show(cur_char);
 ...
 } } } if( landscape[11+ 1 ][11+ -2 ] != 0 ){ action[ Mario.KEY_RIGHT ] = false ;
 ...
 } if( observation.isMarioOnGround() ){ if( observation.isMarioOnGround() ){ if( landscape[11+ 3 ][11+ 0 ] != -10 ){ action[ Mario.KEY_RIGHT ] = false ;
