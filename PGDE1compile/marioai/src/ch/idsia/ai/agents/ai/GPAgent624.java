 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent624 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 }else{ if( observation.mayMarioJump() ){ if( observation.isMarioOnGround() ){ if( landscape[11+ -1 ][11+ -1 ] != 1 ){ action[ Mario.KEY_DOWN ] = true ;
