 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent696 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 } }else{ if( observation.isMarioOnGround() ){ if( observation.isMarioOnGround() ){ if( enemies[11+ -1 ][11+ 1 ] != 1 ){ action[ Mario.KEY_SPEED ] = true ;
