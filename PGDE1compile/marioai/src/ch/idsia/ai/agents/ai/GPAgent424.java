 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent424 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 if( enemies[11+ 0 ][11+ 1 ] != 1 ){ if( enemies[11+ 1 ][11+ 0 ] != 1 ){ action[ Mario.KEY_RIGHT ] = false ;
 ...
 } } if( landscape[11+ 1 ][11+ 0 ] != 1 ){ if( enemies[11+ 0 ][11+ -1 ] != 1 ){ action[ Mario.KEY_JUMP ] = true ;
 action[ Mario.KEY_DOWN ] = false ;
 }else{ action[ Mario.KEY_SPEED ] = true ;
