 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent826 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 } } } if( landscape[11+ -1 ][11+ 0 ] != 1 ){ if( landscape[11+ -1 ][11+ 1 ] != 1 ){ if( enemies[11+ 1 ][11+ 1 ] != 1 ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_DOWN ] = true ;
 }else{ action[ Mario.KEY_JUMP ] = true ;
 } }else{ action[ Mario.KEY_DOWN ] = true ;
