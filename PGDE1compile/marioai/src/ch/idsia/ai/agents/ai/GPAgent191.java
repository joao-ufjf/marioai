 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent191 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 action[ Mario.KEY_JUMP ] = true ;
 } if( observation.mayMarioJump() ){ if( observation.isMarioOnGround() ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_JUMP ] = true ;
 action[ Mario.KEY_RIGHT ] = false ;
