...
//                        show(cur_char);
	...
	byte[][] landscape = observation.getLevelSceneObservation();// default: ZLevelScene = 1  
	 ...
	 if( observation.mayMarioJump() ){ if( observation.mayMarioJump() ){ if( enemies[11+ 0 ][11+ -1 ] != 1 ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_RIGHT ] = true ;
 ...
 } if( enemies[11+ 1 ][11+ -1 ] != 1 ){ if( enemies[11+ 0 ][11+ 0 ] != 1 ){ action[ Mario.KEY_RIGHT ] = true ;
 ...
 } }else{ if( enemies[11+ 0 ][11+ -1 ] != 1 ){ if( landscape[11+ 0 ][11+ 1 ] != 1 ){ if( enemies[11+ -1 ][11+ 0 ] != 1 ){ action[ Mario.KEY_JUMP ] = true ;
