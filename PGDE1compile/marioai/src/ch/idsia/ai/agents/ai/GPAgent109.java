...
//                        show(cur_char);
 ...
 } }else{ if( landscape[11+ 0 ][11+ -1 ] != -11 ){ if( enemies[11+ -3 ][11+ 0 ] != Sprite.KIND_GOOMBA_WINGED ){ action[ Mario.KEY_RIGHT ] = true ;
 ...
 } if( landscape[11+ 3 ][11+ 1 ] != 21 ){ if( observation.mayMarioJump() ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_DOWN ] = true ;
 } } } if( observation.isMarioOnGround() ){ if( enemies[11+ 0 ][11+ 1 ] != Sprite.KIND_GOOMBA ){ if( observation.mayMarioJump() ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_DOWN ] = false ;
 }else{ action[ Mario.KEY_RIGHT ] = true ;
 } } } } if( landscape[11+ -2 ][11+ -3 ] != 16 ){ if( observation.mayMarioJump() ){ if( observation.mayMarioJump() ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_JUMP ] = true ;
 } } }else{ action[ Mario.KEY_JUMP ] = false ;
