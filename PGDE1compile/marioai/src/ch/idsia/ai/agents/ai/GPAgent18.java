 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent18 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
	...
	byte[][] landscape = observation.getLevelSceneObservation();// default: ZLevelScene = 1  
	 ...
	 if( enemies[11+ 2 ][11+ 0 ] != Sprite.KIND_GOOMBA_WINGED ){ if( landscape[11+ 2 ][11+ 2 ] != 21 ){ action[ Mario.KEY_DOWN ] = true ;
