...
//                        show(cur_char);
 ...
 } if( observation.isMarioOnGround() ){ if( enemies[11+ 0 ][11+ -2 ] != Sprite.KIND_GOOMBA ){ if( enemies[11+ 3 ][11+ -1 ] != Sprite.KIND_RED_KOOPA_WINGED ){ action[ Mario.KEY_SPEED ] = false ;
 ...
 if( enemies[11+ -3 ][11+ 1 ] != Sprite.KIND_BULLET_BILL ){ action[ Mario.KEY_RIGHT ] = false ;
 action[ Mario.KEY_JUMP ] = false ;
 }else{ action[ Mario.KEY_SPEED ] = false ;
 } if( enemies[11+ 1 ][11+ 3 ] != Sprite.KIND_GOOMBA ){ if( observation.mayMarioJump() ){ if( enemies[11+ -3 ][11+ 3 ] != Sprite.KIND_GOOMBA ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_LEFT ] = true ;
