 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent94 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 } } } } if( enemies[11+ 1 ][11+ 3 ] != Sprite.KIND_BULLET_BILL ){ if( landscape[11+ 1 ][11+ 2 ] != -10 ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_RIGHT ] = false ;
 } } }else{ if( enemies[11+ 0 ][11+ 3 ] != Sprite.KIND_RED_KOOPA ){ if( landscape[11+ -3 ][11+ -1 ] != 20 ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_JUMP ] = true ;
 } }else{ if( observation.isMarioOnGround() ){ action[ Mario.KEY_LEFT ] = true ;
 } action[ Mario.KEY_LEFT ] = false ;
 } }else{ if( observation.mayMarioJump() ){ if( observation.isMarioOnGround() ){ if( landscape[11+ 2 ][11+ 1 ] != 0 ){ action[ Mario.KEY_RIGHT ] = false ;
 }else{ action[ Mario.KEY_JUMP ] = true ;
 } } } } } 	
	//Begin of BGPAgent
	return action;
