 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent43 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
	...
	byte[][] landscape = observation.getLevelSceneObservation();// default: ZLevelScene = 1  
	 ...
	 if( observation.isMarioOnGround() ){ if( landscape[11+ 2 ][11+ -1 ] != 20 ){ action[ Mario.KEY_JUMP ] = true ;
 ...
 }else{ if( landscape[11+ -3 ][11+ 1 ] != 20 ){ action[ Mario.KEY_RIGHT ] = false ;
 ...
 } if( observation.isMarioOnGround() ){ if( enemies[11+ 0 ][11+ -2 ] != Sprite.KIND_GREEN_KOOPA_WINGED ){ if( enemies[11+ -2 ][11+ 1 ] != Sprite.KIND_GOOMBA ){ if( landscape[11+ -2 ][11+ 2 ] != -11 ){ action[ Mario.KEY_LEFT ] = false ;
 action[ Mario.KEY_SPEED ] = true ;
 ...
 action[ Mario.KEY_SPEED ] = true ;
 } } if( enemies[11+ 0 ][11+ -1 ] != Sprite.KIND_BULLET_BILL ){ if( observation.isMarioOnGround() ){ if( observation.mayMarioJump() ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_LEFT ] = false ;
 } } } } if( enemies[11+ 1 ][11+ 3 ] != Sprite.KIND_BULLET_BILL ){ if( landscape[11+ 1 ][11+ 2 ] != 21 ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_DOWN ] = false ;
 if( enemies[11+ 0 ][11+ 0 ] != Sprite.KIND_SPIKY_WINGED ){ action[ Mario.KEY_DOWN ] = true ;
 }else{ action[ Mario.KEY_RIGHT ] = true ;
 } } } }else{ if( observation.mayMarioJump() ){ if( observation.mayMarioJump() ){ if( landscape[11+ 2 ][11+ 3 ] != -11 ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_LEFT ] = true ;
