 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent186 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
	...
	byte[][] landscape = observation.getLevelSceneObservation();// default: ZLevelScene = 1  
	 ...
	 if( observation.mayMarioJump() ){ if( observation.mayMarioJump() ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_LEFT ] = true ;
 ...
 } } } if( enemies[11+ 1 ][11+ 1 ] != Sprite.KIND_SPIKY_WINGED ){ action[ Mario.KEY_RIGHT ] = false ;
 ...
 } } } if( enemies[11+ -3 ][11+ -2 ] != Sprite.KIND_SPIKY ){ if( enemies[11+ 1 ][11+ 2 ] != Sprite.KIND_SPIKY ){ if( landscape[11+ -1 ][11+ -3 ] != -10 ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_JUMP ] = true ;
 } if( observation.isMarioOnGround() ){ action[ Mario.KEY_SPEED ] = false ;
 }else{ action[ Mario.KEY_LEFT ] = true ;
 } }else{ if( landscape[11+ -1 ][11+ 2 ] != 16 ){ action[ Mario.KEY_LEFT ] = true ;
 } } } }else{ if( observation.isMarioOnGround() ){ if( landscape[11+ 0 ][11+ 3 ] != -10 ){ action[ Mario.KEY_LEFT ] = false ;
 ...
 action[ Mario.KEY_DOWN ] = false ;
 } } if( enemies[11+ 2 ][11+ 0 ] != Sprite.KIND_SPIKY ){ if( observation.isMarioOnGround() ){ if( observation.mayMarioJump() ){ if( landscape[11+ 1 ][11+ -2 ] != -11 ){ action[ Mario.KEY_JUMP ] = true ;
 }else{ action[ Mario.KEY_DOWN ] = false ;
 } } } } if( observation.mayMarioJump() ){ if( observation.isMarioOnGround() ){ if( landscape[11+ 0 ][11+ 3 ] != -11 ){ if( landscape[11+ 0 ][11+ 1 ] != -11 ){ if( landscape[11+ 1 ][11+ 2 ] != 21 ){ action[ Mario.KEY_SPEED ] = false ;
 } } }else{ if( landscape[11+ 0 ][11+ 2 ] != -10 ){ action[ Mario.KEY_DOWN ] = true ;
 }else{ action[ Mario.KEY_LEFT ] = true ;
 } action[ Mario.KEY_SPEED ] = true ;
 } }else{ if( landscape[11+ 1 ][11+ 1 ] != -11 ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_LEFT ] = true ;
 }else{ action[ Mario.KEY_RIGHT ] = true ;
 } } } }else{ if( observation.mayMarioJump() ){ if( landscape[11+ 1 ][11+ -2 ] != -10 ){ action[ Mario.KEY_JUMP ] = true ;
