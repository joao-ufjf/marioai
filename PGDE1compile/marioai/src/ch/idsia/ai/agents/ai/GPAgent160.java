...
//                        show(cur_char);
	...
	byte[][] landscape = observation.getLevelSceneObservation();// default: ZLevelScene = 1  
	 ...
	 if( observation.mayMarioJump() ){ if( landscape[11+ 1 ][11+ 2 ] != -11 ){ if( observation.isMarioOnGround() ){ if( landscape[11+ 1 ][11+ -2 ] != 16 ){ if( landscape[11+ 1 ][11+ 0 ] != -11 ){ action[ Mario.KEY_LEFT ] = true ;
 ...
 }else{ if( observation.isMarioOnGround() ){ if( landscape[11+ 1 ][11+ -2 ] != -11 ){ action[ Mario.KEY_LEFT ] = false ;
 } }else{ if( landscape[11+ -1 ][11+ 2 ] != 0 ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_JUMP ] = true ;
 }else{ action[ Mario.KEY_SPEED ] = false ;
 } } action[ Mario.KEY_RIGHT ] = true ;
