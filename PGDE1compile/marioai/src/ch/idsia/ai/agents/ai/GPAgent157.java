 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent157 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 } }else{ if( enemies[11+ -1 ][11+ -1 ] != Sprite.KIND_GOOMBA ){ action[ Mario.KEY_SPEED ] = true ;
 } } } if( observation.isMarioOnGround() ){ action[ Mario.KEY_DOWN ] = true ;
 }else{ action[ Mario.KEY_JUMP ] = false ;
 } if( landscape[11+ -2 ][11+ -3 ] != -11 ){ if( enemies[11+ -3 ][11+ 3 ] != Sprite.KIND_RED_KOOPA ){ action[ Mario.KEY_JUMP ] = false ;
 ...
 action[ Mario.KEY_LEFT ] = true ;
 } } if( enemies[11+ 2 ][11+ 0 ] != Sprite.KIND_SPIKY ){ if( observation.isMarioOnGround() ){ if( observation.mayMarioJump() ){ if( enemies[11+ 3 ][11+ 3 ] != Sprite.KIND_GREEN_KOOPA_WINGED ){ action[ Mario.KEY_RIGHT ] = false ;
 }else{ action[ Mario.KEY_JUMP ] = false ;
 } } } } if( landscape[11+ -3 ][11+ 3 ] != -11 ){ if( landscape[11+ 1 ][11+ 1 ] != -10 ){ if( enemies[11+ -3 ][11+ 3 ] != Sprite.KIND_RED_KOOPA ){ if( landscape[11+ -2 ][11+ 1 ] != 20 ){ action[ Mario.KEY_JUMP ] = true ;
 } if( landscape[11+ 2 ][11+ 0 ] != 0 ){ action[ Mario.KEY_SPEED ] = false ;
 }else{ action[ Mario.KEY_LEFT ] = true ;
 } } } }else{ if( enemies[11+ 3 ][11+ -2 ] != Sprite.KIND_RED_KOOPA_WINGED ){ if( observation.isMarioOnGround() ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_SPEED ] = true ;
 }else{ action[ Mario.KEY_RIGHT ] = false ;
