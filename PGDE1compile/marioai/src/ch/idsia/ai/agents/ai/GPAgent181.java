...
//                        show(cur_char);
 ...
 } if( observation.isMarioOnGround() ){ if( enemies[11+ 1 ][11+ -3 ] != Sprite.KIND_GOOMBA ){ if( observation.mayMarioJump() ){ if( landscape[11+ -2 ][11+ 2 ] != -10 ){ action[ Mario.KEY_DOWN ] = false ;
 ...
 } }else{ if( observation.isMarioOnGround() ){ if( landscape[11+ 0 ][11+ 3 ] != -10 ){ action[ Mario.KEY_SPEED ] = false ;
 }else{ action[ Mario.KEY_RIGHT ] = true ;
