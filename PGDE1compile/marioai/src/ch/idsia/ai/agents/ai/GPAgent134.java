...
//                        show(cur_char);
	...
	byte[][] landscape = observation.getLevelSceneObservation();// default: ZLevelScene = 1  
	 ...
	 if( observation.mayMarioJump() ){ if( observation.isMarioOnGround() ){ if( observation.isMarioOnGround() ){ if( landscape[11+ 1 ][11+ 0 ] != 16 ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_LEFT ] = false ;
 ...
 action[ Mario.KEY_DOWN ] = true ;
 } if( enemies[11+ -1 ][11+ 1 ] != Sprite.KIND_SPIKY ){ if( observation.mayMarioJump() ){ if( enemies[11+ -2 ][11+ 1 ] != Sprite.KIND_BULLET_BILL ){ action[ Mario.KEY_RIGHT ] = false ;
 action[ Mario.KEY_JUMP ] = true ;
 }else{ if( observation.mayMarioJump() ){ action[ Mario.KEY_JUMP ] = true ;
 }else{ action[ Mario.KEY_JUMP ] = false ;
 } } }else{ if( observation.mayMarioJump() ){ if( enemies[11+ 1 ][11+ 0 ] != Sprite.KIND_GOOMBA ){ action[ Mario.KEY_DOWN ] = false ;
