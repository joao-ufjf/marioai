 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent975 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 if( observation.isMarioOnGround() ){ if( observation.mayMarioJump() ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_LEFT ] = true ;
 ...
 }else{ if( observation.mayMarioJump() ){ if( landscape[11+ 0 ][11+ -1 ] != 1 ){ action[ Mario.KEY_RIGHT ] = false ;
 }else{ action[ Mario.KEY_SPEED ] = false ;
