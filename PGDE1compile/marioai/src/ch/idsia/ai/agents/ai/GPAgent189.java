 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent189 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 } } if( observation.isMarioOnGround() ){ if( enemies[11+ 0 ][11+ -3 ] != Sprite.KIND_RED_KOOPA_WINGED ){ if( enemies[11+ -1 ][11+ 1 ] != Sprite.KIND_GOOMBA ){ if( landscape[11+ -3 ][11+ -3 ] != 16 ){ action[ Mario.KEY_RIGHT ] = true ;
 }else{ action[ Mario.KEY_RIGHT ] = true ;
 ...
 } } } if( landscape[11+ 3 ][11+ -1 ] != -11 ){ if( landscape[11+ -2 ][11+ -2 ] != 20 ){ action[ Mario.KEY_DOWN ] = false ;
 } }else{ if( observation.mayMarioJump() ){ action[ Mario.KEY_LEFT ] = true ;
 action[ Mario.KEY_DOWN ] = false ;
 } } if( enemies[11+ -3 ][11+ 2 ] != Sprite.KIND_GOOMBA_WINGED ){ action[ Mario.KEY_LEFT ] = false ;
 } action[ Mario.KEY_RIGHT ] = false ;
 if( landscape[11+ 0 ][11+ 2 ] != 20 ){ action[ Mario.KEY_RIGHT ] = true ;
 action[ Mario.KEY_LEFT ] = false ;
