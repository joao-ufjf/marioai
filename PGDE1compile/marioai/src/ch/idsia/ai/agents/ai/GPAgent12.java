...
//                        show(cur_char);
 ...
 if( observation.isMarioOnGround() ){ if( landscape[11+ 2 ][11+ -2 ] != -11 ){ action[ Mario.KEY_RIGHT ] = true ;
 }else{ action[ Mario.KEY_LEFT ] = false ;
 } } action[ Mario.KEY_JUMP ] = true ;
 action[ Mario.KEY_RIGHT ] = true ;
 action[ Mario.KEY_SPEED ] = false ;
 if( observation.mayMarioJump() ){ if( landscape[11+ 0 ][11+ -2 ] != 20 ){ action[ Mario.KEY_RIGHT ] = true ;
 action[ Mario.KEY_SPEED ] = true ;
 } }else{ if( landscape[11+ -1 ][11+ 0 ] != -10 ){ action[ Mario.KEY_SPEED ] = false ;
 } action[ Mario.KEY_SPEED ] = true ;
 } 	
	//Begin of BGPAgent
	return action;
