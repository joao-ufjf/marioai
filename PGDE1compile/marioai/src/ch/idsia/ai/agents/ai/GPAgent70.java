...
//                        show(cur_char);
 ...
 } } if( landscape[11+ -2 ][11+ -3 ] != -11 ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_DOWN ] = false ;
 if( observation.isMarioOnGround() ){ action[ Mario.KEY_DOWN ] = true ;
 }else{ action[ Mario.KEY_DOWN ] = true ;
 } }else{ if( enemies[11+ -2 ][11+ -1 ] != Sprite.KIND_SPIKY ){ if( landscape[11+ 0 ][11+ -3 ] != -11 ){ action[ Mario.KEY_RIGHT ] = false ;
 } } } } if( observation.isMarioOnGround() ){ action[ Mario.KEY_JUMP ] = true ;
