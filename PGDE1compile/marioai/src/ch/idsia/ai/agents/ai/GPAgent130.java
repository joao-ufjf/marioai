 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent130 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 } }else{ if( enemies[11+ 3 ][11+ -1 ] != Sprite.KIND_GREEN_KOOPA ){ action[ Mario.KEY_SPEED ] = false ;
 } } } if( observation.isMarioOnGround() ){ if( enemies[11+ 0 ][11+ -3 ] != Sprite.KIND_SPIKY_WINGED ){ if( observation.mayMarioJump() ){ if( landscape[11+ -3 ][11+ -3 ] != 16 ){ action[ Mario.KEY_SPEED ] = false ;
 }else{ action[ Mario.KEY_RIGHT ] = true ;
 } }else{ if( observation.isMarioOnGround() ){ action[ Mario.KEY_JUMP ] = false ;
 } } if( landscape[11+ 0 ][11+ -3 ] != -11 ){ action[ Mario.KEY_DOWN ] = false ;
 }else{ action[ Mario.KEY_JUMP ] = false ;
 action[ Mario.KEY_RIGHT ] = true ;
 } } } if( enemies[11+ 0 ][11+ -3 ] != Sprite.KIND_GOOMBA ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_RIGHT ] = false ;
 if( landscape[11+ 0 ][11+ -2 ] != -11 ){ action[ Mario.KEY_RIGHT ] = false ;
 ...
 } } if( enemies[11+ 2 ][11+ 0 ] != Sprite.KIND_SPIKY ){ if( observation.isMarioOnGround() ){ if( observation.mayMarioJump() ){ if( landscape[11+ 1 ][11+ -2 ] != -11 ){ action[ Mario.KEY_LEFT ] = true ;
 }else{ action[ Mario.KEY_DOWN ] = false ;
 } } } } if( landscape[11+ -3 ][11+ 3 ] != -11 ){ if( landscape[11+ 1 ][11+ 0 ] != -10 ){ if( enemies[11+ -3 ][11+ 3 ] != Sprite.KIND_RED_KOOPA ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_LEFT ] = true ;
