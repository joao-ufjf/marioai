...
//                        show(cur_char);
 ...
 if( enemies[11+ 0 ][11+ -1 ] != 1 ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_JUMP ] = false ;
 action[ Mario.KEY_LEFT ] = false ;
 }else{ action[ Mario.KEY_JUMP ] = false ;
 ...
 }else{ if( landscape[11+ 1 ][11+ -1 ] != 1 ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_SPEED ] = true ;
