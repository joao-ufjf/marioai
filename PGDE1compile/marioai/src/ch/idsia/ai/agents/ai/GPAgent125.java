...
//                        show(cur_char);
 ...
 } }else{ if( landscape[11+ 0 ][11+ 1 ] != -11 ){ if( observation.mayMarioJump() ){ if( enemies[11+ 0 ][11+ 2 ] != Sprite.KIND_GOOMBA ){ action[ Mario.KEY_LEFT ] = false ;
 ...
 }else{ if( enemies[11+ 2 ][11+ -1 ] != Sprite.KIND_BULLET_BILL ){ if( enemies[11+ 2 ][11+ 2 ] != Sprite.KIND_SPIKY ){ action[ Mario.KEY_RIGHT ] = false ;
