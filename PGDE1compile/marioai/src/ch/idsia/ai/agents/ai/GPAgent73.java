 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent73 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 }else{ if( landscape[11+ -3 ][11+ 2 ] != -10 ){ action[ Mario.KEY_SPEED ] = false ;
 ...
 action[ Mario.KEY_JUMP ] = false ;
 } } if( observation.mayMarioJump() ){ if( observation.isMarioOnGround() ){ if( enemies[11+ -2 ][11+ 1 ] != Sprite.KIND_RED_KOOPA ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_LEFT ] = false ;
 action[ Mario.KEY_DOWN ] = true ;
 ...
 } } } }else{ if( observation.mayMarioJump() ){ if( observation.mayMarioJump() ){ if( landscape[11+ 0 ][11+ -1 ] != -11 ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_LEFT ] = true ;
