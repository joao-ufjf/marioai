...
//                        show(cur_char);
 ...
 if( enemies[11+ -1 ][11+ -1 ] != Sprite.KIND_SPIKY_WINGED ){ if( enemies[11+ -1 ][11+ -1 ] != Sprite.KIND_RED_KOOPA_WINGED ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_DOWN ] = false ;
 }else{ action[ Mario.KEY_LEFT ] = true ;
 } }else{ action[ Mario.KEY_SPEED ] = false ;
 } action[ Mario.KEY_DOWN ] = false ;
 } if( observation.mayMarioJump() ){ if( enemies[11+ 2 ][11+ 2 ] != Sprite.KIND_BULLET_BILL ){ if( landscape[11+ 2 ][11+ 1 ] != -11 ){ action[ Mario.KEY_LEFT ] = false ;
 ...
 } } if( enemies[11+ 2 ][11+ 0 ] != Sprite.KIND_RED_KOOPA ){ action[ Mario.KEY_JUMP ] = true ;
 }else{ if( enemies[11+ -2 ][11+ 1 ] != Sprite.KIND_GREEN_KOOPA ){ action[ Mario.KEY_RIGHT ] = false ;
 } } if( landscape[11+ -2 ][11+ 2 ] != 0 ){ if( enemies[11+ 2 ][11+ -1 ] != Sprite.KIND_GOOMBA ){ if( observation.mayMarioJump() ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_JUMP ] = false ;
 } }else{ action[ Mario.KEY_SPEED ] = true ;
 } } } 	
	//Begin of BGPAgent
	return action;
