 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent44 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 } if( observation.isMarioOnGround() ){ if( enemies[11+ -1 ][11+ 1 ] != 1 ){ action[ Mario.KEY_JUMP ] = true ;
 } }else{ action[ Mario.KEY_JUMP ] = false ;
 } } } } }else{ if( observation.mayMarioJump() ){ if( observation.mayMarioJump() ){ if( enemies[11+ 0 ][11+ 0 ] != 1 ){ action[ Mario.KEY_JUMP ] = true ;
