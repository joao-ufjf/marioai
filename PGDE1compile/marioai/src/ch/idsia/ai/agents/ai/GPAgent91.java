 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent91 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 } } } } } if( landscape[11+ -2 ][11+ -3 ] != -11 ){ if( observation.mayMarioJump() ){ if( landscape[11+ 0 ][11+ -2 ] != 20 ){ action[ Mario.KEY_JUMP ] = true ;
 ...
 } } } } if( observation.isMarioOnGround() ){ if( landscape[11+ 1 ][11+ 2 ] != 21 ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_DOWN ] = false ;
