 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent147 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 if( enemies[11+ 2 ][11+ 1 ] != Sprite.KIND_GOOMBA ){ action[ Mario.KEY_SPEED ] = true ;
 }else{ action[ Mario.KEY_LEFT ] = true ;
 } }else{ if( enemies[11+ -3 ][11+ -2 ] != Sprite.KIND_BULLET_BILL ){ action[ Mario.KEY_JUMP ] = true ;
 action[ Mario.KEY_DOWN ] = false ;
 }else{ if( observation.mayMarioJump() ){ action[ Mario.KEY_LEFT ] = false ;
 }else{ action[ Mario.KEY_SPEED ] = false ;
 } } } action[ Mario.KEY_LEFT ] = true ;
 action[ Mario.KEY_LEFT ] = true ;
 if( observation.mayMarioJump() ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_LEFT ] = false ;
 action[ Mario.KEY_RIGHT ] = true ;
 } action[ Mario.KEY_RIGHT ] = false ;
 } if( observation.isMarioOnGround() ){ if( enemies[11+ 0 ][11+ -2 ] != Sprite.KIND_SPIKY ){ if( enemies[11+ -3 ][11+ 0 ] != Sprite.KIND_GREEN_KOOPA ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_RIGHT ] = false ;
 }else{ if( landscape[11+ 3 ][11+ 0 ] != -10 ){ action[ Mario.KEY_DOWN ] = false ;
 }else{ action[ Mario.KEY_RIGHT ] = true ;
 } } } } } if( landscape[11+ 0 ][11+ -3 ] != -10 ){ if( observation.mayMarioJump() ){ if( enemies[11+ 2 ][11+ 3 ] != Sprite.KIND_GOOMBA ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_JUMP ] = true ;
 ...
 action[ Mario.KEY_SPEED ] = true ;
 } } if( observation.mayMarioJump() ){ if( enemies[11+ 3 ][11+ -1 ] != Sprite.KIND_GREEN_KOOPA_WINGED ){ if( observation.isMarioOnGround() ){ if( landscape[11+ 3 ][11+ 3 ] != 20 ){ action[ Mario.KEY_JUMP ] = false ;
 } } } } if( observation.mayMarioJump() ){ if( landscape[11+ 0 ][11+ -3 ] != -10 ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_RIGHT ] = false ;
 } action[ Mario.KEY_JUMP ] = true ;
 action[ Mario.KEY_DOWN ] = true ;
 } if( observation.isMarioOnGround() ){ if( observation.isMarioOnGround() ){ if( landscape[11+ -3 ][11+ 0 ] != 20 ){ action[ Mario.KEY_SPEED ] = true ;
