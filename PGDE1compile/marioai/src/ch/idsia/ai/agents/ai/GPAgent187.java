 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent187 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 }else{ if( landscape[11+ 3 ][11+ 0 ] != -10 ){ action[ Mario.KEY_JUMP ] = true ;
 ...
 action[ Mario.KEY_SPEED ] = true ;
 } } if( observation.mayMarioJump() ){ if( enemies[11+ 3 ][11+ -1 ] != Sprite.KIND_GREEN_KOOPA_WINGED ){ if( observation.mayMarioJump() ){ if( landscape[11+ 3 ][11+ 3 ] != 20 ){ action[ Mario.KEY_JUMP ] = false ;
 } } } } if( observation.mayMarioJump() ){ if( landscape[11+ 0 ][11+ -3 ] != -10 ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_RIGHT ] = false ;
 } action[ Mario.KEY_JUMP ] = true ;
 action[ Mario.KEY_DOWN ] = true ;
 } if( observation.isMarioOnGround() ){ if( observation.isMarioOnGround() ){ if( landscape[11+ -3 ][11+ 0 ] != 20 ){ action[ Mario.KEY_RIGHT ] = false ;
