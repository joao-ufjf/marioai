 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent111 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 } } } if( observation.mayMarioJump() ){ if( enemies[11+ 0 ][11+ -3 ] != Sprite.KIND_SPIKY ){ action[ Mario.KEY_JUMP ] = false ;
 }else{ action[ Mario.KEY_JUMP ] = true ;
 ...
 } if( enemies[11+ 0 ][11+ 1 ] != Sprite.KIND_GREEN_KOOPA ){ action[ Mario.KEY_LEFT ] = true ;
