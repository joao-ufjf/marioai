 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent270 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 if( observation.isMarioOnGround() ){ if( enemies[11+ 1 ][11+ 1 ] != 1 ){ if( enemies[11+ 1 ][11+ 0 ] != 1 ){ action[ Mario.KEY_DOWN ] = false ;
