...
//                        show(cur_char);
 ...
 }else{ if( observation.isMarioOnGround() ){ if( landscape[11+ 2 ][11+ 0 ] != 20 ){ if( enemies[11+ 1 ][11+ 0 ] != Sprite.KIND_BULLET_BILL ){ action[ Mario.KEY_DOWN ] = false ;
 ...
 } if( landscape[11+ 0 ][11+ -2 ] != -10 ){ action[ Mario.KEY_JUMP ] = true ;
 } } } } 	
	//Begin of BGPAgent
	return action;
    }
