...
//                        show(cur_char);
	...
	byte[][] landscape = observation.getLevelSceneObservation();// default: ZLevelScene = 1  
	 ...
	 if( observation.mayMarioJump() ){ if( observation.isMarioOnGround() ){ if( landscape[11+ 0 ][11+ -2 ] != 20 ){ if( landscape[11+ 1 ][11+ 0 ] != 16 ){ if( landscape[11+ 1 ][11+ 0 ] != -11 ){ action[ Mario.KEY_LEFT ] = true ;
 } }else{ if( landscape[11+ 1 ][11+ -1 ] != 20 ){ if( enemies[11+ 0 ][11+ 0 ] != Sprite.KIND_SPIKY ){ action[ Mario.KEY_RIGHT ] = true ;
 ...
 } if( enemies[11+ -1 ][11+ 1 ] != Sprite.KIND_SPIKY ){ if( observation.mayMarioJump() ){ if( enemies[11+ 0 ][11+ 2 ] != Sprite.KIND_GOOMBA ){ action[ Mario.KEY_RIGHT ] = false ;
 action[ Mario.KEY_LEFT ] = false ;
 }else{ if( observation.mayMarioJump() ){ action[ Mario.KEY_JUMP ] = true ;
 }else{ action[ Mario.KEY_JUMP ] = false ;
 } } }else{ if( enemies[11+ 1 ][11+ -1 ] != Sprite.KIND_RED_KOOPA_WINGED ){ action[ Mario.KEY_DOWN ] = false ;
