 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent143 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 } } if( landscape[11+ -1 ][11+ 0 ] != 0 ){ if( observation.isMarioOnGround() ){ if( landscape[11+ 3 ][11+ -3 ] != 21 ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_LEFT ] = false ;
 }else{ action[ Mario.KEY_RIGHT ] = true ;
 ...
 } } } } if( enemies[11+ 1 ][11+ -1 ] != Sprite.KIND_BULLET_BILL ){ if( landscape[11+ 1 ][11+ 2 ] != 16 ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_JUMP ] = true ;
 action[ Mario.KEY_SPEED ] = false ;
 if( observation.isMarioOnGround() ){ action[ Mario.KEY_SPEED ] = true ;
 } } } }else{ if( enemies[11+ 1 ][11+ 3 ] != Sprite.KIND_BULLET_BILL ){ if( enemies[11+ 0 ][11+ -2 ] != Sprite.KIND_RED_KOOPA ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_RIGHT ] = false ;
 }else{ action[ Mario.KEY_DOWN ] = false ;
 ...
 } if( enemies[11+ -2 ][11+ 3 ] != Sprite.KIND_GOOMBA ){ action[ Mario.KEY_DOWN ] = false ;
 } } 	
	//Begin of BGPAgent
	return action;
    }
