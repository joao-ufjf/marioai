 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent330 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 } }else{ if( enemies[11+ 0 ][11+ -1 ] != 1 ){ if( enemies[11+ 1 ][11+ 1 ] != 1 ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_DOWN ] = true ;
