 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent98 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 } if( observation.isMarioOnGround() ){ if( enemies[11+ 0 ][11+ -2 ] != Sprite.KIND_GOOMBA ){ if( enemies[11+ -1 ][11+ 1 ] != Sprite.KIND_GOOMBA ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_SPEED ] = false ;
 ...
 } } } } if( observation.isMarioOnGround() ){ if( landscape[11+ 0 ][11+ -3 ] != -10 ){ if( observation.mayMarioJump() ){ action[ Mario.KEY_RIGHT ] = true ;
 } action[ Mario.KEY_JUMP ] = true ;
 action[ Mario.KEY_SPEED ] = true ;
 } if( observation.isMarioOnGround() ){ if( landscape[11+ 0 ][11+ -2 ] != -11 ){ action[ Mario.KEY_DOWN ] = true ;
