...
//                        show(cur_char);
	...
	byte[][] landscape = observation.getLevelSceneObservation();// default: ZLevelScene = 1  
	 ...
	 if( observation.isMarioOnGround() ){ if( enemies[11+ 3 ][11+ -2 ] != Sprite.KIND_BULLET_BILL ){ if( enemies[11+ -1 ][11+ 0 ] != Sprite.KIND_GOOMBA_WINGED ){ if( observation.isMarioOnGround() ){ if( landscape[11+ 3 ][11+ -1 ] != 0 ){ action[ Mario.KEY_RIGHT ] = true ;
 ...
 } } if( observation.mayMarioJump() ){ if( landscape[11+ 3 ][11+ 2 ] != -10 ){ action[ Mario.KEY_DOWN ] = false ;
 ...
 } } } }else{ if( landscape[11+ 3 ][11+ 1 ] != 21 ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_SPEED ] = false ;
