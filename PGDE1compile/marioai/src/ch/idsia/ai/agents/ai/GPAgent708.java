 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent708 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 if( enemies[11+ 1 ][11+ -1 ] != 1 ){ if( observation.isMarioOnGround() ){ if( enemies[11+ 1 ][11+ 1 ] != 1 ){ action[ Mario.KEY_SPEED ] = false ;
 ...
 } } if( observation.mayMarioJump() ){ if( enemies[11+ 0 ][11+ 0 ] != 1 ){ if( landscape[11+ -1 ][11+ 0 ] != 1 ){ action[ Mario.KEY_JUMP ] = false ;
