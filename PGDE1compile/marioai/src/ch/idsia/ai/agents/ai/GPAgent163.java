 ...
 * Package: ch.idsia.ai.agents.ai;
 */
public class GPAgent163 extends BasicAIAgent implements Agent
{
...
//                        show(cur_char);
 ...
 } } } if( landscape[11+ -1 ][11+ 0 ] != 1 ){ if( observation.mayMarioJump() ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_RIGHT ] = false ;
