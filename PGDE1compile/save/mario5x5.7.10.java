//geracao 99 level: 2 fit: 3723
 ...
 } if( enemies[11+ 1 ][11+ 0 ] != 1 ){ if( enemies[11+ 2 ][11+ -1 ] != 1 ){ if( enemies[11+ 2 ][11+ 0 ] != 1 ){ if( observation.isMarioOnGround() ){ action[ Mario.KEY_RIGHT ] = true ;
 } } }else{ if( observation.isMarioOnGround() ){ action[ Mario.KEY_RIGHT ] = true ;
 } } } if( landscape[11+ 1 ][11+ 1 ] != 1 ){ if( observation.isMarioOnGround() ){ if( landscape[11+ 0 ][11+ -1 ] != 1 ){ if( enemies[11+ 1 ][11+ -2 ] != 1 ){ action[ Mario.KEY_LEFT ] = false ;
 }else{ if( observation.mayMarioJump() ){ action[ Mario.KEY_SPEED ] = true ;
 } } } }else{ if( enemies[11+ 0 ][11+ 2 ] != 1 ){ if( enemies[11+ 1 ][11+ 2 ] != 1 ){ if( landscape[11+ 1 ][11+ -1 ] != 1 ){ action[ Mario.KEY_JUMP ] = true ;
